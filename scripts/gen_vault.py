...
FACET_LABEL = {
    ...
    "sector": ("กลุ่มอุตสาหกรรม", "กลุ่มหลักในพอร์ต (factsheet; ต่างประเทศเสริมด้วย Yahoo)"),
    "cap": ("ขนาดบริษัท", "ใหญ่ ≥1หมื่นล้าน$ / กลาง 2พัน–1หมื่นล้าน / เล็ก <2พันล้าน (จาก Yahoo)"),
