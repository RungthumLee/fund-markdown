...
3. **Rate limit: ไม่เจอ 429 เลย** — เรียงต่อกัน 12.1 req/s · ขนาน 8 threads
   **73 req/s** ก็ยังไม่เจอ (การยิงเรียงถูกจำกัดด้วย latency ~80 ms ไม่ใช่ limiter)
   → backfill ใช้ขนาน ≤4 threads ได้สบาย ดู [[outstanding|OUT-002]]

**ต้นทุน backfill ที่ประเมินใหม่จากของจริง:** NAV 1 ปีของ 1 กอง ≈ 165 แถว ≈ 2 API call
(page_size 100) → 5 ปี × ~2,300 กอง ≈ **~23,000 call** ≈ 50 นาทีที่ 8 req/s
(หรือ ~10 นาทีถ้าขนาน 4) — ทำครั้งเดียว หลังจากนั้น append รายวันถูกมาก
