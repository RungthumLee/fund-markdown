...
entity_id: "isin:LU1861217161"
isin: "LU1861217161"
ticker: "BGFFTD2"
figi: "BBG00LSKRWZ0"
share_class_figi: "BBG00LSLK2M5"
...
**ประเภท:** หน่วยลงทุน · **ISIN:** `LU1861217161` · **Ticker:** `BGFFTD2 (LX)`
...
`BGF FINTECH-D2 USD` · `BGFFTD2` · `BGFFTD2 LX` · `BGFL`

## กองทุนไทยที่ถือโดยตรง (2 กอง)

| กองทุน | บลจ. | % NAV | นโยบาย |
|---|---|---|---|
| [[B-FINTECH\|B-FINTECH]] | บริษัทหลักทรัพย์จัดการกองทุนรวม  บัวหลวง จำกัด | 99.34% | ตราสารทุน |
| [[MFTECH\|MFTECH]] | บริษัทหลักทรัพย์จัดการกองทุน เอ็มเอฟซี จำกัด (มหาชน) | 27.79% | ตราสารทุน |
