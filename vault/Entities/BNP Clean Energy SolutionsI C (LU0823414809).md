...
`BNP PARIBAS ASSET MANAGEMENT LUXEMBOURG SA` · `FORBIICLX`

## กองทุนไทยที่ถือโดยตรง (2 กอง)

| กองทุน | บลจ. | % NAV | นโยบาย |
|---|---|---|---|
| [[SCBCLEAN\|SCBCLEAN]] | บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด | 100.40% | ตราสารทุน |
| [[SCBRMCLEAN\|SCBRMCLEAN]] | บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด | 99.24% | ตราสารทุน |
