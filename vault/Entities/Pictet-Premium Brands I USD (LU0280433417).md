...
entity_id: "isin:LU0280433417"
isin: "LU0280433417"
ticker: "PFPREMI"
figi: "BBG000K93Y63"
share_class_figi: "BBG001SPQJD7"
...
**ประเภท:** หน่วยลงทุน · **ISIN:** `LU0280433417` · **Ticker:** `PFPREMI (LX)`
...
`PFPREMI` · `PFPREMLX` · `PICTET` · `Pictet Funds (Europe) S.A.`

## กองทุนไทยที่ถือโดยตรง (2 กอง)

| กองทุน | บลจ. | % NAV | นโยบาย |
|---|---|---|---|
| [[KT-LUXURY\|KT-LUXURY]] | บริษัทหลักทรัพย์จัดการกองทุน กรุงไทย จำกัด (มหาชน) | 100.16% | ตราสารทุน |
| [[ES-PREMIUMBRAND\|ES-PREMIUMBRAND]] | บริษัทหลักทรัพย์จัดการกองทุน อีสท์สปริง (ประเทศไทย) จำกัด | 99.05% | ตราสารทุน |
