...
`GOLDMAN SACHS GROUP, INC.` · `GS US` · `GSUS` · `GSUSa`

## กองทุนไทยที่ถือโดยตรง (4 กอง)

| กองทุน | บลจ. | % NAV | นโยบาย |
|---|---|---|---|
| [[TLGSELECT\|TLGSELECT]] | บริษัทหลักทรัพย์จัดการกองทุน ทาลิส จำกัด | 2.80% | ผสม |
