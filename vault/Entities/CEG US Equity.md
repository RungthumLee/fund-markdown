...
**ประเภท:** หุ้น · **ISIN:** `US21037T1097` · **Ticker:** `CEG (US)`

**ตลาดซื้อขาย:** สหรัฐฯ

**กลุ่ม:** Utilities · **อุตสาหกรรม:** Utilities - Independent Power Producers · **ขนาด:** ใหญ่ (100,059,955,200 USD)
...
`CEGUW` · `CONSTELLATION ENERGY` · `CONSTELLATION ENERGY CORPORATION`
...
|---|---|---|---|
| [[PRINCIPAL GCLEAN\|PRINCIPAL GCLEAN]] | บริษัทหลักทรัพย์จัดการกองทุน พรินซิเพิล จำกัด | 8.88% | VanEck Uranium and Nuclear ETF |
| [[TUSUTIL\|TUSUTIL]] | บริษัทหลักทรัพย์จัดการกองทุน ทิสโก้ | 5.59% | State Street Utilities Select Sector SPDR ETF |

## กองทุนไทยที่ถือโดยตรง (2 กอง)

| กองทุน | บลจ. | % NAV | นโยบาย |
|---|---|---|---|
| [[SCBBLNFUND\|SCBBLNFUND]] | บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด | 3.00% | ตราสารทุน |
