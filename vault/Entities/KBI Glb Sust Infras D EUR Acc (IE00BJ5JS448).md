...
entity_id: "isin:IE00BJ5JS448"
isin: "IE00BJ5JS448"
ticker: "KBGSIED"
figi: "BBG00NS64QH5"
share_class_figi: "BBG00NTM6H50"
...
**ประเภท:** หน่วยลงทุน · **ISIN:** `IE00BJ5JS448` · **Ticker:** `KBGSIED (ID)`
...
`Amundi Luxembourg S.A.` · `KBGSIED` · `KBI GLOBAL SUSTAINABLE INFRASTRUCTURE D (EUR) ACC`

## กองทุนไทยที่ถือโดยตรง (2 กอง)

| กองทุน | บลจ. | % NAV | นโยบาย |
|---|---|---|---|
| [[MINFRA\|MINFRA]] | บริษัทหลักทรัพย์จัดการกองทุน เอ็มเอฟซี จำกัด (มหาชน) | 99.50% | ตราสารทุน |
| [[UINFRA\|UINFRA]] | บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด | 13.52% | ตราสารทุน |
