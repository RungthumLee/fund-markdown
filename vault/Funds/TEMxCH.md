...
> - **NAV 16.8193 (2026-08-26)**

> [!tip] อ่านง่าย ๆ
> กองหุ้น · ความเสี่ยงสูง (6/8) · เหมาะกับสะสมระยะยาว · ขายคืนแล้วได้เงินภายใน T+5 · เน้นกลุ่มเทคโนโลยี · ลงทุนต่างประเทศ (ไต้หวัน) · ป้องกันค่าเงินบางส่วน · ลงทุนผ่านกองทุนหลัก (feeder) · บริหารเชิงรุก (active) · ค่าธรรมเนียมรวมที่รายย่อยจ่ายจริงราว 1.30%/ปี
...
|---|---|---|---|
| หุ้นไทย (SET) | +0.52 | ไปทางเดียวกัน | 474 |
| หุ้นตลาดเกิดใหม่ (EM) | +0.52 | ไปทางเดียวกัน | 481 |
| หุ้นสหรัฐ (S&P 500) | +0.48 | ไปทางเดียวกัน | 481 |

> **วัดจาก NAV รายวัน** ช่วง 2024-06-06..2026-08-26 (ที่มา: NAV × Yahoo) · +1 = ไปทางเดียวกัน · −1 = สวนทาง
...
|---|---|---|---|---|---|
| main | 2026-08-26 | 16.8193 | 17.0296 | 16.8193 | 1,477,153,385 |

อ่านเพิ่ม: [[NAV และราคาซื้อขายหน่วยลงทุน]]

### NAV ย้อนหลัง 2024-06-06 → 2026-08-26 (ชนิด `main`)

`▁▂▁▁▁▂▂▁▁▁▁▁▁▁▁▁▁▁▂▂▂▂▂▃▃▃▃▃▃▄▄▅▅▄▄▆▆███▇▇`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2024-06-06 → 2026-08-26 | 504 | 68.1% | 20.1% |
| 1 ปี | 2025-08-26 → 2026-08-26 | 242 | 52.69% | 23.6% |

สูงสุด 17.478 · ต่ำสุด 8.657 (ตลอดช่วงที่เก็บ)
