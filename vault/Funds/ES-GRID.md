...
> [!tip] อ่านง่าย ๆ
> กองหุ้น · ความเสี่ยงสูง (6/8) · เหมาะกับสะสมระยะยาว · ขายคืนแล้วได้เงินภายใน T+2 · เน้นกลุ่มอุตสาหกรรม · ลงทุนต่างประเทศ (สหรัฐฯ) · ป้องกันความเสี่ยงค่าเงินเต็มจำนวน · ลงทุนผ่านกองทุนหลัก (feeder) · บริหารแบบอิงดัชนี (passive) · ค่าธรรมเนียมรวมที่รายย่อยจ่ายจริงราว 1.46%/ปี
...
> ทะลุถึงหลักทรัพย์จริงได้ **59.2%** ของกอง (ส่วนที่เหลือ 40.8% ยังไม่ทะลุ) · ที่มา: look-through (Yahoo top holdings) · symbol/ISIN
...
|---|---|---|---|
| หุ้นตลาดเกิดใหม่ (EM) | +0.86 | ไปทางเดียวกัน | 89 |
| หุ้นสหรัฐ (S&P 500) | +0.78 | ไปทางเดียวกัน | 89 |
| ราคาทองคำ | +0.48 | ไปทางเดียวกัน | 89 |
| ดอกเบี้ยสหรัฐ 10 ปี | -0.41 | สวนทาง | 89 |

> **วัดจาก NAV รายวัน** ช่วง 2026-04-02..2026-08-26 (ที่มา: NAV × Yahoo) · +1 = ไปทางเดียวกัน · −1 = สวนทาง
...
|---|---|---|---|---|---|
| main | 2026-08-26 | 10.716 | 10.8768 | 10.716 | 4,836,115,3 |

อ่านเพิ่ม: [[NAV และราคาซื้อขายหน่วยลงทุน]]

### NAV ย้อนหลัง 2026-04-02 → 2026-08-26 (ชนิด `main`)

`▁▂▃▅▄▅▆▅▇▇██▇▅▆█▇█▅▅▆▆▆█▅▅▇▅▄▅▄▄▃▄▃▃▃▅▅▅▅▆▄▄▃`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2026-04-02 → 2026-08-26 | 90 | 7.13% | 27.4% |

สูงสุด 11.9216 · ต่ำสุด 10.0029 (ตลอดช่วงที่เก็บ)
