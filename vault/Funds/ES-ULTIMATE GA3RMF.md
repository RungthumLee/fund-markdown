---
title: "ES-ULTIMATE GA3RMF"
proj_id: M0874_2568
regis_id: "MF0552_2568"
abbr: "ES-ULTIMATE GA3RMF"
name_th: "กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 3 เพื่อการเลี้ยงชีพ"
name_en: "Eastspring Ultimate Global Allocation Fund 3 RMF"
...
nav: 11.4082
nav_date: "2026-08-26"
fund_size: 144103411.48
holdings_count: 3
top10_pct_nav: 99.48
market_countries: ["ไทย"]
country_top: "ไทย"
country_coverage_pct: 97.9
master_fund: "กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 3"
...
| รายการ | ค่า |
|---|---|
| เลขที่โครงการ (proj_id) | `M0874_2568` |
| เลขที่จดทะเบียน (regis_id) | MF0552_2568 |
| ชื่อย่อ | ES-ULTIMATE GA3RMF |
| ชื่อไทย | กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 3 เพื่อการเลี้ยงชีพ |
| ชื่ออังกฤษ | Eastspring Ultimate Global Allocation Fund 3 RMF |
...
- **กองทุนหลัก:** กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 3
- **ประเทศ:** ไทย
- 🌐 **โน้ตกองทุนหลัก:** [[ES-ULTIMATE GA3]] — ค่าธรรมเนียม ขนาดกองทุน sector และหลักทรัพย์ที่ถือจริง
...
> ลงทุนในตราสารทุน ตราสารหนี้ และ/หรือทรัพย์สินทางเลือก โดยในสภาวะปกติมีสัดส่วนการลงทุนในตราสารทุน โดยเฉลี่ยในรอบปีบัญชีไม่เกินร้อยละ 79 ของ NAV
...
|---|---|---|---|---|---|
| ผลตอบแทนกองทุนรวม | 4.64 | 9.88 | 12.65 | 13.13 | 0.43 |
| ผลตอบแทนตัวชี้วัด | - | - | - | - | - |
| ค่าเฉลี่ยในกลุ่มเดียวกัน | - | - | - | - | - |
| ความผันผวนของกองทุนรวม | 7.38 | 9.02 | 9.07 | 9.16 | - |
...
|---|---|---|
| 1 | ไม่มี | ไม่มีดัชนีมาตรฐาน เนื่องจากกองทุนหลักไม่มีดัชนีชี้วัด แต่อย่างไรก็ตาม กองทุนหลักมีการเปิดเผยอัตราผลตอบแทนขั้นต่ำ (Hurdle Rate) เท่ากับร้อยละ 8 ต่อปี ซึ่งเป็นอัตราผลตอบแทนเฉลี่ยต่อปี สำหรับระยะเวลาการลงทุนตั้งแต่ 3 ปีขึ้นไป ซึ่งคำนวณมาจากการจัดทำแบบจำลองการลงทุนย้อนหลัง 10 ปี ที่คำนวณจากผลการดำเนินงา |
...
|---|---|---|---|
| หุ้นสหรัฐ (S&P 500) | +0.65 | ไปทางเดียวกัน | 181 |
| หุ้นตลาดเกิดใหม่ (EM) | +0.45 | ไปทางเดียวกัน | 181 |
...
| # | หลักทรัพย์ | สัดส่วน (%) |
|---|---|---|
| 1 | หน่วยลงทุนของกองทุนรวมแบบผสม : กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 3 (ES-ULTIMATE GA3) | 96.8 |

### สัดส่วนตามประเภทสินทรัพย์ (งวด 202607)

| รหัส | ประเภทสินทรัพย์ | มูลค่าตลาด | % NAV |
|---|---|---|---|
| 108 | หน่วยลงทุน (รหัส 108-109,117-121,139,130) | 117,105,698 | 96.7978 |
| 201 | เงินฝากธนาคาร P/N และ B/E (รหัส 202-205,216-224) | 3,097,338 | 2.5602 |
| 700 | สินทรัพย์อื่นๆ/หนี้สินอื่นๆ (รหัส 122,211,301-399,500-599) หัก (รหัส 601-699) | 776,615 | 0.6419 |

### รายการลงทุนรายตัวทั้งหมด (งวด 202606 · ณ 2026-06-30)

- จำนวนรายการที่ถือ: **3** รายการ จากผู้ออก 2 ราย
- มูลค่าทรัพย์สินสุทธิของกองทุน: **91,809,926** บาท
- น้ำหนัก 10 อันดับแรกรวม: **99.48% ของ NAV** (คิดเป็น 100.0% ของพอร์ต)

| # | หลักทรัพย์ | ผู้ออก | ประเภท | ISIN | มูลค่า | % NAV |
|---|---|---|---|---|---|---|
| 1 | เปิดอีสท์สปริง Ultimate Global Allocation 3 <br><sub>`ES-ULTIMATE GA3`</sub> | Eastspring Asset Management (Thailand) C | หน่วยลงทุนของกองทุนรวมแบบผสม | THC669010009 | 89,885,209 | 97.9036 |
| 2 | [[../Entities/Bank Of Ayudhya Public Company Limited\|Bank Of Ayudhya Public Company Limited]] <br><sub>`BAY - S/A`</sub> | Bank Of Ayudhya Public Company Limited | เงินฝากธนาคารประเภทออมทรัพย์ | - | 1,445,499 | 1.5744 |
| 3 | [[../Entities/Bank Of Ayudhya Public Company Limited\|Bank Of Ayudhya Public Company Limited]] <br><sub>`BAY - C/A`</sub> | Bank Of Ayudhya Public Company Limited | เงินฝากธนาคารประเภทกระแสรายวัน | - | 2, | 0.0022 |

## 8. NAV

| Class | วันที่ | NAV/หน่วย | ราคาขาย | ราคารับซื้อคืน | มูลค่าทรัพย์สินสุทธิ |
|---|---|---|---|---|---|
| main | 2026-08-26 | 11.4082 | 11.4083 | 11.4082 | 144,103,411 |
...
|---|---|---|---|---|
| ทั้งช่วง | 2025-10-15 → 2026-08-26 | 182 | 14.09% | 9.1% |
| 1 ปี | 2025-10-15 → 2026-08-26 | 182 | 14.09% | 9.1% |

สูงสุด 11.5699 · ต่ำสุด 9.8129 (ตลอดช่วงที่เก็บ)
...
📄 ข้อความที่แกะจาก PDF: [[Factsheet - ES-ULTIMATE GA3RMF]]

- class `main` (ณ 2026-07-31) — [PDF](https://secdocumentstorage.blob.core.windows.net/fundfactsheet/M0874_2568.pdf)
...
- กองทุนหลักที่ลงทุนจริง: [[ES-ULTIMATE GA3]]
