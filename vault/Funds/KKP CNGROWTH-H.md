---
title: "KKP CNGROWTH-H"
proj_id: M0702_2569
regis_id: "MF0347_2569"
abbr: "KKP CNGROWTH-H"
name_th: "กองทุนเปิดเคเคพี หุ้นจีนเติบโต เฮดจ์"
name_en: "KKP ALL CHINA GROWTH FUND - HEDGED"
...
| รายการ | ค่า |
|---|---|
| เลขที่โครงการ (proj_id) | `M0702_2569` |
| เลขที่จดทะเบียน (regis_id) | MF0347_2569 |
| ชื่อย่อ | KKP CNGROWTH-H |
| ชื่อไทย | กองทุนเปิดเคเคพี หุ้นจีนเติบโต เฮดจ์ |
| ชื่ออังกฤษ | KKP ALL CHINA GROWTH FUND - HEDGED |
...
|---|---|---|
| 1 | Hong Kong Overnight Interbank Offered Rate?(HK Assoc of Banks Hong Kong Dollar HIBOR Fixings Overnight at 11:00am) | (2) 5% Hong Kong Overnight Interbank Offer Rate ปรับด้วยอัตราแลกเปลี่ยนเป็นสกุลเงิน USD และปรับด้วยต้นทุนการป้องกันความเสี่ยงอัตราแลกเปลี่ยน USDTHB เพื่อคำนวณผลตอบแทนเป็นสกุลเงินบาท ณ วันที่คำนวณผลตอบแทน |
| 2 | MSCI China Free SMID Price HKD | (1) 95% MSCI China Free SMID Index (HKD) ปรับด้วยอัตราแลกเปลี่ยนเป็นสกุลเงิน USD และปรับด้วยต้นทุนการป้องกันความเสี่ยงอัตราแลกเปลี่ยน USDTHB เพื่อคำนวณผลตอบแทนเป็นสกุลเงินบาท ณ วันที่คำนวณผลตอบแทน |
...
|---|---|---|---|
| 108 | หน่วยลงทุน (รหัส 108-109,117-121,139,130) | 225,625,361 | 97.662 |
| 401 | ตราสารอนุพันธ์(รหัส 401-407) | 2,958,778 | 1.2807 |
| 201 | เงินฝากธนาคาร P/N และ B/E (รหัส 202-205,216-224) | 2,859,481 | 1.2377 |
| 700 | สินทรัพย์อื่นๆ/หนี้สินอื่นๆ (รหัส 122,211,301-399,500-599) หัก (รหัส 601-699) | -416,81 | -0.1804 |

## 8. NAV

| Class | วันที่ | NAV/หน่วย | ราคาขาย | ราคารับซื้อคืน | มูลค่าทรัพย์สินสุทธิ |
|---|---|---|---|---|---|
| main | 2026-08-25 | 9.8897 | 10.0381 | 9.8897 | 260,637,609 |
...
|---|---|---|---|---|
| ทั้งช่วง | 2026-07-21 → 2026-08-25 | 23 | -1.1% | 29.8% |

สูงสุด 10.2994 · ต่ำสุด 9.4305 (ตลอดช่วงที่เก็บ)
...
📄 ข้อความที่แกะจาก PDF: [[Factsheet - KKP CNGROWTH-H]]

- class `main` (ณ 2026-07-13) — [PDF](https://secdocumentstorage.blob.core.windows.net/fundfactsheet/M0702_2569.pdf)
