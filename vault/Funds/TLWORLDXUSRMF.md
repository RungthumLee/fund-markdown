...
title: "TLWORLDXUSRMF"
proj_id: M0700_2569
regis_id: "MF0335_2569"
abbr: "TLWORLDXUSRMF"
name_th: "กองทุนเปิดทาลิส เวิลด์ เอ็กซ์ ยูเอส เพื่อการเลี้ยงชีพ"
name_en: "TALIS WORLD EX US RETIREMENT MUTUAL FUND"
...
nav: 10.0194
nav_date: "2026-08-26"
fund_size: 6650136.46
master_fund: "Vanguard Total International Stock Index Fund ETF Shares"
tags: [fund, sec-data, asset/equity, risk/high, liquidity/t2, fx/unhedged, struct/feeder, style/passive, tax/rmf, use/tax-saving]
---

# TLWORLDXUSRMF

**กองทุนเปิดทาลิส เวิลด์ เอ็กซ์ ยูเอส เพื่อการเลี้ยงชีพ**  
_TALIS WORLD EX US RETIREMENT MUTUAL FUND_

บลจ. [[บริษัทหลักทรัพย์จัดการกองทุน ทาลิส จำกัด]] · นโยบาย [[ตราสารทุน]] · ความเสี่ยงระดับ **6**

> [!abstract] สรุปย่อ
> - **รหัสโครงการ:** `M0700_2569`
...
> - **NAV 10.0194 (2026-08-26)**

> [!tip] อ่านง่าย ๆ
> กองหุ้น · ความเสี่ยงสูง (6/8) · เหมาะกับลดหย่อนภาษี · ขายคืนแล้วได้เงินภายใน T+2 · ลงทุนต่างประเทศ · ไม่ป้องกันความเสี่ยงค่าเงิน · ลงทุนผ่านกองทุนหลัก (feeder) · บริหารแบบอิงดัชนี (passive) · ค่าธรรมเนียมรวมที่รายย่อยจ่ายจริงราว 0.98%/ปี · ได้สิทธิลดหย่อนภาษี (RMF)

## 1. ข้อมูลทั่วไป

| รายการ | ค่า |
|---|---|
| เลขที่โครงการ (proj_id) | `M0700_2569` |
| เลขที่จดทะเบียน (regis_id) | MF0335_2569 |
| ชื่อย่อ | TLWORLDXUSRMF |
| ชื่อไทย | กองทุนเปิดทาลิส เวิลด์ เอ็กซ์ ยูเอส เพื่อการเลี้ยงชีพ |
| ชื่ออังกฤษ | TALIS WORLD EX US RETIREMENT MUTUAL FUND |
...
1. กองทุนเป็นกองทุนรวมฟีดเดอร์ (Feeder Fund) ที่เน้นลงทุนในหน่วยลงทุนของกองทุน Vanguard Total International Stock ETF (กองทุนหลัก) เพียงกองทุนเดียว โดยกองทุนจะลงทุนในกองทุนหลักโดยเฉลี่ยในรอบปีบัญชีไม่น้อยกว่าร้อยละ 80 ของมูลค่าทรัพย์สินสุทธิของกองทุนรวม และลงทุนในสกุลเงินดอลลาร์สหรัฐฯ
...
|---|---|---|---|
| 101 | หุ้น (รหัส 101-102) | 4,418,506 | 96.3872 |
| 201 | เงินฝากธนาคาร P/N และ B/E (รหัส 202-205,216-224) | 111,608 | 2.4347 |
| 700 | สินทรัพย์อื่นๆ/หนี้สินอื่นๆ (รหัส 122,211,301-399,500-599) หัก (รหัส 601-699) | 54,008 | 1.1781 |

## 8. NAV

| Class | วันที่ | NAV/หน่วย | ราคาขาย | ราคารับซื้อคืน | มูลค่าทรัพย์สินสุทธิ |
|---|---|---|---|---|---|
| main | 2026-08-26 | 10.0194 | 10.0195 | 10.0194 | 6,650,136 |
...
|---|---|---|---|---|
| ทั้งช่วง | 2026-07-15 → 2026-08-26 | 28 | 0.24% | 13.6% |

สูงสุด 10.1335 · ต่ำสุด 9.787 (ตลอดช่วงที่เก็บ)
...
📄 ข้อความที่แกะจาก PDF: [[Factsheet - TLWORLDXUSRMF]]

- class `main` (ณ 2026-07-09) — [PDF](https://secdocumentstorage.blob.core.windows.net/fundfactsheet/M0700_2569.pdf)
