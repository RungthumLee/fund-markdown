...
|---|---|---|---|---|---|
| main | 2026-08-26 | 9.8726 | 10.0312 | 9.8726 | 31,724,318 |

อ่านเพิ่ม: [[NAV และราคาซื้อขายหน่วยลงทุน]]

### NAV ย้อนหลัง 2026-08-20 → 2026-08-26 (ชนิด `main`)

`▆█▂▅▁`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2026-08-20 → 2026-08-26 | 5 | -1.16% | -% |

สูงสุด 10.0428 · ต่ำสุด 9.8726 (ตลอดช่วงที่เก็บ)
