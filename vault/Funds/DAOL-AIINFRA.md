...
title: "DAOL-AIINFRA"
proj_id: M0643_2569
regis_id: "MF0332_2569"
abbr: "DAOL-AIINFRA"
name_th: "กองทุนเปิด ดาโอ เอไอ อินฟราสตรัคเจอร์"
name_en: "DAOL AI INFRASTRUCTURE FUND"
...
| รายการ | ค่า |
|---|---|
| เลขที่โครงการ (proj_id) | `M0643_2569` |
| เลขที่จดทะเบียน (regis_id) | MF0332_2569 |
| ชื่อย่อ | DAOL-AIINFRA |
| ชื่อไทย | กองทุนเปิด ดาโอ เอไอ อินฟราสตรัคเจอร์ |
| ชื่ออังกฤษ | DAOL AI INFRASTRUCTURE FUND |
...
5.3.3 ปฏิบัติตามแนวทางการดำเนินการตาม 5.3.1ภายใน 60 วันนับแต่วัน …(ตัดทอน)
...
|---|---|---|---|
| 108 | หน่วยลงทุน (รหัส 108-109,117-121,139,130) | 46,051,748 | 61.8853 |
| 700 | สินทรัพย์อื่นๆ/หนี้สินอื่นๆ (รหัส 122,211,301-399,500-599) หัก (รหัส 601-699) | 25,500,444 | 34.2681 |
| 201 | เงินฝากธนาคาร P/N และ B/E (รหัส 202-205,216-224) | 2,191,845 | 2.9455 |
| 401 | ตราสารอนุพันธ์(รหัส 401-407) | 670,596 | 0.9012 |

## 8. NAV

| Class | วันที่ | NAV/หน่วย | ราคาขาย | ราคารับซื้อคืน | มูลค่าทรัพย์สินสุทธิ |
|---|---|---|---|---|---|
| main | 2026-08-26 | 9.2602 | 9.4089 | 9.2602 | 152,475,104 |
...
|---|---|---|---|---|
| ทั้งช่วง | 2026-07-15 → 2026-08-26 | 28 | -7.32% | 44.9% |

สูงสุด 10.294 · ต่ำสุด 9.0159 (ตลอดช่วงที่เก็บ)
...
📄 ข้อความที่แกะจาก PDF: [[Factsheet - DAOL-AIINFRA]]

- class `main` (ณ 2026-07-08) — [PDF](https://secdocumentstorage.blob.core.windows.net/fundfactsheet/M0643_2569.pdf)
