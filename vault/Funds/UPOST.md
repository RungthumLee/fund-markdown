...
title: "UPOST"
proj_id: M0708_2569
regis_id: "MF0382_2569"
abbr: "UPOST"
name_th: "กองทุนเปิด ยูไนเต็ด โพส สตราทีจิค กลายด์-พาธ ฟันด์"
name_en: "United Post Strategic Glide-path Fund"
...
| รายการ | ค่า |
|---|---|
| เลขที่โครงการ (proj_id) | `M0708_2569` |
| เลขที่จดทะเบียน (regis_id) | MF0382_2569 |
| ชื่อย่อ | UPOST |
| ชื่อไทย | กองทุนเปิด ยูไนเต็ด โพส สตราทีจิค กลายด์-พาธ ฟันด์ |
| ชื่ออังกฤษ | United Post Strategic Glide-path Fund |
| บลจ. | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] |
| สถานะ | Registered |
| วันจัดตั้ง | 2026-06-30 |
...
- **กองทุนหลัก:** T. Rowe Price Funds SICAV – Retirement Allocation Fund – 1
- **ประเทศ:** ลักเซมเบิร์ก
- 🌐 **โน้ตกองทุนหลัก:** [[T. Rowe Price Funds SICAV – Retirement Allocation Fund – 1]] — ค่าธรรมเนียม ขนาดกองทุน sector และหลักทรัพย์ที่ถือจริง
...
> รายละเอียดทั้งหมดดูที่ [[Factsheet - UPOST]]

## 8. NAV

| Class | วันที่ | NAV/หน่วย | ราคาขาย | ราคารับซื้อคืน | มูลค่าทรัพย์สินสุทธิ |
|---|---|---|---|---|---|
| main | 2026-08-26 | 9.9336 | 10.033 | 9.9336 | 105,429,851 |
...
|---|---|---|---|---|
| ทั้งช่วง | 2026-08-03 → 2026-08-26 | 16 | -0.66% | 3.4% |

สูงสุด 10 · ต่ำสุด 9.8853 (ตลอดช่วงที่เก็บ)
...
📄 ข้อความที่แกะจาก PDF: [[Factsheet - UPOST]]

- class `main` (ณ 2026-08-20) — [PDF](https://secdocumentstorage.blob.core.windows.net/fundfactsheet/M0708_2569.pdf)
...
- กองทุนหลักที่ลงทุนจริง: [[T. Rowe Price Funds SICAV – Retirement Allocation Fund – 1]]
