---
title: "ES-ULTIMATE GA2RMF"
proj_id: M0873_2568
regis_id: "MF0551_2568"
abbr: "ES-ULTIMATE GA2RMF"
name_th: "กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 2 เพื่อการเลี้ยงชีพ"
name_en: "Eastspring Ultimate Global Allocation Fund 2 RMF"
...
> - **NAV 11.298 (2026-08-26)**

> [!tip] อ่านง่าย ๆ
> กองผสม · ความเสี่ยงปานกลาง (5/8) · เหมาะกับลดหย่อนภาษี · ขายคืนแล้วได้เงินภายใน T+5 · ลงทุนต่างประเทศ (ไทย) · ป้องกันค่าเงินตามดุลยพินิจผู้จัดการ · ลงทุนผ่านกองทุนหลัก (feeder) · บริหารเชิงรุก (active) · ค่าธรรมเนียมรวมที่รายย่อยจ่ายจริงราว 0.16%/ปี · ได้สิทธิลดหย่อนภาษี (RMF)

## 1. ข้อมูลทั่วไป

| รายการ | ค่า |
|---|---|
| เลขที่โครงการ (proj_id) | `M0873_2568` |
| เลขที่จดทะเบียน (regis_id) | MF0551_2568 |
| ชื่อย่อ | ES-ULTIMATE GA2RMF |
| ชื่อไทย | กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 2 เพื่อการเลี้ยงชีพ |
| ชื่ออังกฤษ | Eastspring Ultimate Global Allocation Fund 2 RMF |
...
- **กองทุนหลัก:** กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 2
- **ประเทศ:** ไทย
- 🌐 **โน้ตกองทุนหลัก:** [[ES-ULTIMATE GA2]] — ค่าธรรมเนียม ขนาดกองทุน sector และหลักทรัพย์ที่ถือจริง
...
> ลงทุนในตราสารทุน ตราสารหนี้ และ/หรือทรัพย์สินทางเลือก โดยในสภาวะปกติมีสัดส่วนการลงทุนในตราสารทุน โดยเฉลี่ยในรอบปีบัญชีไม่เกินร้อยละ 65 ของ NAV
...
|---|---|---|---|---|---|
| ผลตอบแทนกองทุนรวม | 4.17 | 9.37 | 11.59 | 12.24 | 0.58 |
| ผลตอบแทนตัวชี้วัด | - | - | - | - | - |
| ค่าเฉลี่ยในกลุ่มเดียวกัน | - | - | - | - | - |
| ความผันผวนของกองทุนรวม | 6.27 | 7.7 | 7.87 | 7.89 | - |
...
|---|---|---|
| 1 | ไม่มี | ไม่มีดัชนีมาตรฐาน เนื่องจากกองทุนหลักไม่มีดัชนีชี้วัด แต่อย่างไรก็ตาม กองทุนหลักมีการเปิดเผยอัตราผลตอบแทนขั้นต่ำ (Hurdle Rate) เท่ากับร้อยละ 6 ต่อปี ซึ่งเป็นอัตราผลตอบแทนเฉลี่ยต่อปี สำหรับระยะเวลาการลงทุนตั้งแต่ 3 ปีขึ้นไป ซึ่งคำนวณมาจากการจัดทำแบบจำลองการลงทุนย้อนหลัง 10 ปี ที่คำนวณจากผลการดำเนินงา |
...
|---|---|---|---|
| หุ้นสหรัฐ (S&P 500) | +0.58 | ไปทางเดียวกัน | 181 |

> **วัดจาก NAV รายวัน** ช่วง 2025-10-15..2026-08-26 (ที่มา: NAV × Yahoo) · +1 = ไปทางเดียวกัน · −1 = สวนทาง
...
| # | หลักทรัพย์ | สัดส่วน (%) |
|---|---|---|
| 1 | หน่วยลงทุนของกองทุนรวมแบบผสม : กองทุนเปิดอีสท์สปริง Ultimate Global Allocation 2 (ES-ULTIMATE GA2) | 96.61 |

### สัดส่วนตามประเภทสินทรัพย์ (งวด 202607)

| รหัส | ประเภทสินทรัพย์ | มูลค่าตลาด | % NAV |
|---|---|---|---|
| 108 | หน่วยลงทุน (รหัส 108-109,117-121,139,130) | 205,710,037 | 96.6124 |
| 201 | เงินฝากธนาคาร P/N และ B/E (รหัส 202-205,216-224) | 4,686,599 | 2.2011 |
| 700 | สินทรัพย์อื่นๆ/หนี้สินอื่นๆ (รหัส 122,211,301-399,500-599) หัก (รหัส 601-699) | 2,526,324 | 1.1865 |

### รายการลงทุนรายตัวทั้งหมด (งวด 202606 · ณ 2026-06-30)

- จำนวนรายการที่ถือ: **3** รายการ จากผู้ออก 2 ราย
- มูลค่าทรัพย์สินสุทธิของกองทุน: **172,444,238** บาท
...
|---|---|---|---|---|---|---|
| 1 | เปิดอีสท์สปริง Ultimate Global Allocation 2 <br><sub>`ES-ULTIMATE GA2`</sub> | Eastspring Asset Management (Thailand) C | หน่วยลงทุนของกองทุนรวมแบบผสม | THC668010000 | 167,916,054 | 97.3741 |
| 2 | [[../Entities/Bank Of Ayudhya Public Company Limited\|Bank Of Ayudhya Public Company Limited]] <br><sub>`BAY - S/A`</sub> | Bank Of Ayudhya Public Company Limited | เงินฝากธนาคารประเภทออมทรัพย์ | - | 5,069,548 | 2.9398 |
| 3 | [[../Entities/Bank Of Ayudhya Public Company Limited\|Bank Of Ayudhya Public Company Limited]] <br><sub>`BAY - C/A`</sub> | Bank Of Ayudhya Public Company Limited | เงินฝากธนาคารประเภทกระแสรายวัน | - | 2, | 0.0012 |

## 8. NAV

| Class | วันที่ | NAV/หน่วย | ราคาขาย | ราคารับซื้อคืน | มูลค่าทรัพย์สินสุทธิ |
|---|---|---|---|---|---|
| main | 2026-08-26 | 11.298 | 11.2981 | 11.298 | 251,181,095 |

อ่านเพิ่ม: [[NAV และราคาซื้อขายหน่วยลงทุน]]

### NAV ย้อนหลัง 2025-10-15 → 2026-08-26 (ชนิด `main`)

`▁▁▁▁▁▁▁▁▁▁▁▁▂▂▂▂▃▃▃▃▃▂▂▃▂▃▃▄▄▅▅▅▆▆▆▆▇▇▇███████`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2025-10-15 → 2026-08-26 | 182 | 12.98% | 7.9% |
| 1 ปี | 2025-10-15 → 2026-08-26 | 182 | 12.98% | 7.9% |

สูงสุด 11.4236 · ต่ำสุด 9.88 (ตลอดช่วงที่เก็บ)
...
📄 ข้อความที่แกะจาก PDF: [[Factsheet - ES-ULTIMATE GA2RMF]]

- class `main` (ณ 2026-07-31) — [PDF](https://secdocumentstorage.blob.core.windows.net/fundfactsheet/M0873_2568.pdf)
...
- กองทุนหลักที่ลงทุนจริง: [[ES-ULTIMATE GA2]]
