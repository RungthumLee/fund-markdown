...
|---|---|---|---|
| หุ้นตลาดเกิดใหม่ (EM) | +0.87 | ไปทางเดียวกัน | 315 |
| หุ้นสหรัฐ (S&P 500) | +0.64 | ไปทางเดียวกัน | 315 |

> **วัดจาก NAV รายวัน** ช่วง 2025-04-11..2026-08-26 (ที่มา: NAV × Yahoo) · +1 = ไปทางเดียวกัน · −1 = สวนทาง
...
|---|---|---|---|---|---|
| main | 2026-08-26 | 16.4899 | 16.49 | 16.4899 | 257,754,769 |

อ่านเพิ่ม: [[NAV และราคาซื้อขายหน่วยลงทุน]]

### NAV ย้อนหลัง 2025-04-11 → 2026-08-26 (ชนิด `main`)

`▁▁▁▁▁▁▂▂▂▂▂▂▂▂▃▃▃▃▃▃▃▃▄▄▄▅▅▄▅▄▅▆█▇████▇▇██`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2025-04-11 → 2026-08-26 | 329 | 77.23% | 24.3% |
| 1 ปี | 2025-08-26 → 2026-08-26 | 243 | 54.21% | 27.2% |

สูงสุด 17.9393 · ต่ำสุด 9.2074 (ตลอดช่วงที่เก็บ)
