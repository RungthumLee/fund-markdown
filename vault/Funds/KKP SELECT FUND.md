...
|---|---|---|---|
| หุ้นไทย (SET) | +0.96 | ไปทางเดียวกัน | 134 |
...
### NAV ย้อนหลัง 2025-12-25 → 2026-08-27 (ชนิด `KKP SELECT-EXL-D`)

`▁▁▁▁▁▂▁▂▄▄▅▄▃▃▃▄▄▄▄▄▄▅▅▅▆▆▆▆▆▆▆▇▇▇███████`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2025-12-25 → 2026-08-27 | 161 | 31.54% | 16.3% |

สูงสุด 23.4057 · ต่ำสุด 17.2641 (ตลอดช่วงที่เก็บ)
