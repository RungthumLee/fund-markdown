...
> - **NAV 9.9161 (2026-08-26)**

> [!tip] อ่านง่าย ๆ
> กองผสม · ความเสี่ยงปานกลาง (5/8) · เหมาะกับลดหย่อนภาษี · ขายคืนแล้วได้เงินภายใน T+5 · ลงทุนต่างประเทศ · ป้องกันค่าเงินตามดุลยพินิจผู้จัดการ · บริหารเชิงรุก (active) · ค่าธรรมเนียมรวมที่รายย่อยจ่ายจริงราว 0.70%/ปี · ได้สิทธิลดหย่อนภาษี (RMF)
...
|---|---|---|---|
| ดอกเบี้ยสหรัฐ 10 ปี | -0.60 | สวนทาง | 39 |
| หุ้นสหรัฐ (S&P 500) | +0.58 | ไปทางเดียวกัน | 39 |
| ราคาน้ำมัน (Brent) | -0.52 | สวนทาง | 39 |

> **วัดจาก NAV รายวัน** ช่วง 2026-06-26..2026-08-26 (ที่มา: NAV × Yahoo) · +1 = ไปทางเดียวกัน · −1 = สวนทาง
...
|---|---|---|---|---|---|
| main | 2026-08-26 | 9.9161 | 9.9162 | 9.9161 | 9,617,879 |

อ่านเพิ่ม: [[NAV และราคาซื้อขายหน่วยลงทุน]]

### NAV ย้อนหลัง 2026-06-26 → 2026-08-26 (ชนิด `main`)

`██████████████▇▆▅▅▅▃▂▂▁▁▃▅▇▅▅▄▄▆▅▄▂▃▁▁▁▂▂`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2026-06-26 → 2026-08-26 | 41 | -0.84% | 2.1% |

สูงสุด 10.0048 · ต่ำสุด 9.8977 (ตลอดช่วงที่เก็บ)
