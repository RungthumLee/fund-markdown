...
|---|---|---|---|
| ราคาทองคำ | +0.90 | ไปทางเดียวกัน | 50 |
| ดัชนีดอลลาร์ (DXY) | -0.52 | สวนทาง | 50 |
| หุ้นตลาดเกิดใหม่ (EM) | +0.44 | ไปทางเดียวกัน | 50 |

> **วัดจาก NAV รายวัน** ช่วง 2026-06-09..2026-08-25 (ที่มา: NAV × Yahoo) · +1 = ไปทางเดียวกัน · −1 = สวนทาง
...
### NAV ย้อนหลัง ~120 วัน (ชนิด `ONE-GOLD-X-UH`)

`▁▁▃▂▄▄▂▂▃▂▂▁▁▂▁▁▁▂▂▃▂▂▂▂▁▂▂▁▁▁▂▃▂▂▂▃▁▁▂▄▃▅▅▅▅▅▆▅▇▇███`

| ช่วง | จำนวนวัน | เปลี่ยนแปลงช่วงนี้ | ความผันผวน (ต่อปี) | สูงสุด | ต่ำสุด |
|---|---|---|---|---|---|
| 2026-06-09 → 2026-08-25 | 53 | 12.93% | 22.4% | 11.2927 | 9.896 |
