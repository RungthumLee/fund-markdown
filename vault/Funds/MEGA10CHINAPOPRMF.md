---
title: "MEGA10CHINAPOPRMF"
proj_id: M0917_2568
regis_id: "MF0557_2568"
abbr: "MEGA10CHINAPOPRMF"
name_th: "กองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND เพื่อการเลี้ยงชีพ"
name_en: "MEGA 10 CHINA POPULAR CONSUMER BRAND RETIREMENT MUTUAL FUND"
...
**กองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND เพื่อการเลี้ยงชีพ**  
_MEGA 10 CHINA POPULAR CONSUMER BRAND RETIREMENT MUTUAL FUND_

บลจ. [[บริษัทหลักทรัพย์จัดการกองทุน ทาลิส จำกัด]] · นโยบาย [[ตราสารทุน]] · ความเสี่ยงระดับ **6**

> [!abstract] สรุปย่อ
> - **รหัสโครงการ:** `M0917_2568`
...
| รายการ | ค่า |
|---|---|
| เลขที่โครงการ (proj_id) | `M0917_2568` |
| เลขที่จดทะเบียน (regis_id) | MF0557_2568 |
| ชื่อย่อ | MEGA10CHINAPOPRMF |
| ชื่อไทย | กองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND เพื่อการเลี้ยงชีพ |
| ชื่ออังกฤษ | MEGA 10 CHINA POPULAR CONSUMER BRAND RETIREMENT MUTUAL FUND |
...
- **กองทุนหลัก:** กองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND
- **ประเทศ:** ไทย
- 🌐 **โน้ตกองทุนหลัก:** [[MEGA10CHINAPOP]] — ค่าธรรมเนียม ขนาดกองทุน sector และหลักทรัพย์ที่ถือจริง
...
1. กองทุนเป็นกองทุนรวมฟีดเดอร์ (Feeder Fund) ที่เน้นลงทุนในหน่วยลงทุนของกองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND หน่วยลงทุนชนิดสะสมมูลค่า (กองทุนหลัก) เพียงกองทุนเดียว โดยกองทุนจะลงทุนในกองทุนหลักโดยเฉลี่ยในรอบปีบัญชีไม่น้อยกว่าร้อยละ 80 ของมูลค่าทรัพย์สินสุทธิของกองทุนรวม
กองทุนหลักเป็นกองทุนซึ่งอยู่ภายใต้การบริหารจัดการของบริษัทจัดการ มีนโยบายลงทุนในตราสารทุน และ/หรือ หลักทรัพย์ที่เกี่ยวข้องกับตราสารทุนของบริษัทที่ดําเนินธุรกิจจำหน่ายสินค้า และ/หรือ ให้บริการ อันเกี่ยวข้องกับการอุปโภคบริโภคในชีวิตประจำวัน ที่ส่วนใหญ่เป็นบริษัทผู้ประกอบการ และ/หรือ เจ้าของตราสินค้า (Brand) และบริการที่เป็นที่รู้จักและได้รับความนิยมเป็นอย่างดีทั้งในประเทศจีนรวมถึงในระดับสากล ที่จดทะเบียนซื้อขายในตลาดหลักทรัพย์ฮ่องกง (Hong Kong Stock Exchange; HKEX) ซึ่งผู้จัดการกองทุนจะพิจารณาเลือกลงทุนในตราสารทุนของบริษัทข้างต้นจากมูลค่าหลักทรัพย์ตามราคาตลาด (Market Capitalization) ขนาดใหญ่และมีสภาพคล่องจํานวน 10 บริษัท โดยกองทุนหลักจะมีการลงทุนที่ส่งผลให้มี Net Exposure ในตราสารทุนข้างต้นโดยเฉลี่ยในรอบปีบัญชีไม่น้อยกว่าร้อยละ 80 ของมูลค่าทรัพย์สินสุทธิของกองทุนหลัก
...
ข้อมูลทั่วไปของ กองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND (กองทุนหลัก)
(แหล่งที่มาของข้อมูล : หนังสือชี้ชวนกองทุนหลัก ข้อมูล ณ วันที่ 6 ตุลาคม 2568)
ชื่อกองทุนกองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND (หน่วยลงทุนชนิดสะสมมูลค่า)
วันที่ได้รับอนุมัติให้จัดตั้ง6 ตุลาคม 2568
อายุโครงการไม่กำหนด …(ตัดทอน)
...
|---|---|---|---|---|---|
| ผลตอบแทนกองทุนรวม | -14.45 | -20.01 | -20.01 | -25.42 | -6.77 |
| ผลตอบแทนตัวชี้วัด | -7.6 | -7.95 | -7.95 | -15.65 | - |
| ค่าเฉลี่ยในกลุ่มเดียวกัน | 6.14 | -1.08 | -1.08 | - | - |
| ความผันผวนของกองทุนรวม | 19.6 | 20.24 | 20.24 | 19.48 | - |
...
| หน่วยลงทุนที่ไม่ได้จดทะเบียนในตลาดหลักทรัพย์ | 90.76 |
| เงินฝากธนาคาร | 8.31 |
...
| # | หลักทรัพย์ | สัดส่วน (%) |
|---|---|---|
| 1 | กองทุนเปิด MEGA 10 CHINA POPULAR CONSUMER BRAND | 90.76 |

### สัดส่วนตามประเภทสินทรัพย์ (งวด 202607)

| รหัส | ประเภทสินทรัพย์ | มูลค่าตลาด | % NAV |
|---|---|---|---|
| 108 | หน่วยลงทุน (รหัส 108-109,117-121,139,130) | 3,184,187 | 93.3734 |
| 201 | เงินฝากธนาคาร P/N และ B/E (รหัส 202-205,216-224) | 270,561 | 7.934 |
| 700 | สินทรัพย์อื่นๆ/หนี้สินอื่นๆ (รหัส 122,211,301-399,500-599) หัก (รหัส 601-699) | -44,582 | -1.3073 |

### รายการลงทุนรายตัวทั้งหมด (งวด 202606 · ณ 2026-06-30)

- จำนวนรายการที่ถือ: **2** รายการ จากผู้ออก 2 ราย
- มูลค่าทรัพย์สินสุทธิของกองทุน: **3,128,969** บาท
- น้ำหนัก 10 อันดับแรกรวม: **99.07% ของ NAV** (คิดเป็น 100.0% ของพอร์ต)

| # | หลักทรัพย์ | ผู้ออก | ประเภท | ISIN | มูลค่า | % NAV |
|---|---|---|---|---|---|---|
| 1 | TALIS ASSET MANAGEMENT COMPANY LIMITED <br><sub>`MEGA10CHINAPOP`</sub> | TALIS ASSET MANAGEMENT COMPANY LIMITED | หน่วยลงทุนของกองทุนตราสารทุน | - | 2,839,759 | 90.757 |
| 2 | [[../Entities/Bank Of Ayudhya Public Company Limited\|Bank Of Ayudhya Public Company Limited]] <br><sub>`MEGA10CHINAPOPRMF_BAY`</sub> | BANK OF AYUDHYA PUBLIC COMPANY LIMITED | เงินฝากธนาคารประเภทออมทรัพย์ | - | 260,012 | 8.3098 |

## 8. NAV

| Class | วันที่ | NAV/หน่วย | ราคาขาย | ราคารับซื้อคืน | มูลค่าทรัพย์สินสุทธิ |
|---|---|---|---|---|---|
| main | 2026-08-26 | 8.1127 | 8.1128 | 8.1127 | 3,471,692 |

อ่านเพิ่ม: [[NAV และราคาซื้อขายหน่วยลงทุน]]

### NAV ย้อนหลัง 2025-10-16 → 2026-08-26 (ชนิด `main`)

`██▇▇█▇▇▇▆▆▆▆▇▇▇▇▇█▇▇▆▅▅▆▅▄▅▅▅▅▄▄▃▃▄▂▃▁▁▁▁▁▂▂▂▂▂▂`

| ช่วง | วันที่ | จำนวนวัน | เปลี่ยนแปลง | ความผันผวน (ต่อปี) |
|---|---|---|---|---|
| ทั้งช่วง | 2025-10-16 → 2026-08-26 | 192 | -18.87% | 19.9% |
| 1 ปี | 2025-10-16 → 2026-08-26 | 192 | -18.87% | 19.9% |

สูงสุด 9.9992 · ต่ำสุด 7.4572 (ตลอดช่วงที่เก็บ)
...
📄 ข้อความที่แกะจาก PDF: [[Factsheet - MEGA10CHINAPOPRMF]]

- class `main` (ณ 2026-06-30) — [PDF](https://secdocumentstorage.blob.core.windows.net/fundfactsheet/M0917_2568.pdf)
...
- กองทุนหลักที่ลงทุนจริง: [[MEGA10CHINAPOP]]
