---
title: "MS INVF Global Opportunity Z"
master_key: "LU0552385535"
isin: "LU0552385535"
...
**ISIN:** `LU0552385535` · **Ticker:** `0P0000RZ2M`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | MS INVF Global Opportunity Z |
| ISIN | `LU0552385535` |
...
| ผู้จัดการกองทุน | Kristian Heugh (เริ่ม 30 Nov 2010) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2010-11-30 |
...
|---|---|---|---|---|---|
| [[PRINCIPAL GOPP]] | [[บริษัทหลักทรัพย์จัดการกองทุน พรินซิเพิล จำกัด]] | 6 | 102.48% | 2.19 | **≈ 3.05** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0000RZ2M`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0552385535:USD))
