---
title: "UBS (Lux) Real Estate Funds Selection - Global (EUR) P-acc"
master_key: "LU1435275141"
isin: "LU1435275141"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | UBS (Lux) Real Estate Funds Selection - Global (EUR) P-acc |
| ISIN | `LU1435275141` |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | Property - Direct Global |
| ผู้จัดการกองทุน | Paul Guest (เริ่ม 28 Jan 2020) |
| วันจัดตั้ง | - |
...
|---|---|---|---|---|---|
| [[UGREF-UI]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | 8+ | 93.84% | 1.32 | - |

---

## แหล่งข้อมูล

- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0349525401:EUR))
- **ค้นเว็บ** — พบ ISIN `LU0349525401` แล้วยืนยันตัวเลขซ้ำกับ FT/Yahoo อีกชั้น
