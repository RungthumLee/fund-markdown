---
title: "iShares World Equity High Income Active UCITS ETF USD Acc"
master_key: "name:ishares world equity high income active ucits etf"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | iShares World Equity High Income Active UCITS ETF USD Acc |
| ISIN | - |
...
|---|---|---|---|---|---|
| [[KKP WIN-UH FUND]] | [[บริษัทหลักทรัพย์จัดการกองทุน เกียรตินาคินภัทร จำกัด]] | 6 | 101.52% | 1.00 | - |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `WINA.AS`)
