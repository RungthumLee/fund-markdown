---
title: "AXA World Funds - Digital Economy A Capitalisation USD"
master_key: "name:axa world digital economy"
...
# 🌐 AXA World Funds - Digital Economy A Capitalisation USD
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | AXA World Funds - Digital Economy A Capitalisation USD |
| ISIN | - |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | Sector Equity Technology |
| ผู้จัดการกองทุน | Pauline Llandric (เริ่ม 02 Jan 2025) |
| วันจัดตั้ง | - |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (FT) | 241.72m GBP |
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **1.75%** |
| ค่าธรรมเนียมแรกเข้า (initial charge) | 5.50% |
...
|---|---|---|---|---|
| [[LHDIGITAL]] | [[บริษัทหลักทรัพย์จัดการกองทุน แลนด์ แอนด์ เฮ้าส์ จำกัด]] | ตราสารทุน | 6 | 83.84% |

---

## แหล่งข้อมูล

- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU1694771590:USD))
- **ค้นเว็บ** — พบ ISIN `LU1694771590` แล้วยืนยันตัวเลขซ้ำกับ FT/Yahoo อีกชั้น
