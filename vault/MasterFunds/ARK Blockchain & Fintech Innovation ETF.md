---
title: "ARK Blockchain & Fintech Innovation ETF"
master_key: "US00214Q7088"
isin: "US00214Q7088"
quote_type: "ETF"
category: "Technology"
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 700.81 ล้าน USD |
...
|---|---|
| YTD | -16.90% |
| 3 ปี (เฉลี่ยต่อปี) | 32.77% |
| 5 ปี (เฉลี่ยต่อปี) | -2.62% |
| Beta (3 ปี) | 2.12 |
...
|---|---|---|---|
| 1 | Shopify Inc Registered Shs -A- Subord Vtg | `SHOP` | 9.22% |
| 2 | Block Inc Class A | `XYZ` | 6.62% |
| 3 | Simplify Managed Futures Strategy ETF | `CTA` | 6.23% |
| 4 | Robinhood Markets Inc Class A | `HOOD` | 5.35% |
| 5 | Coinbase Global Inc Ordinary Shares - Class A | `COIN` | 5.24% |
| 6 | Toast Inc Class A | `TOST` | 5.12% |
| 7 | Circle Internet Group Inc Ordinary Shares - Class A | `CRCL` | 4.77% |
| 8 | Amazon.com Inc | `AMZN` | 4.34% |
| 9 | Palantir Technologies Inc Ordinary Shares - Class A | `PLTR` | 4.22% |
| 10 | Advanced Micro Devices Inc | `AMD` | 3.50% |
...
|---|---|---|---|---|---|
| [[ES-FINTECH]] | [[บริษัทหลักทรัพย์จัดการกองทุน อีสท์สปริง (ประเทศไทย) จำกัด]] | 6 | 60.38% | 1.25 | **≈ 2.00** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `ARKF`)
