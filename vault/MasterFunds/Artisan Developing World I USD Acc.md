---
title: "Artisan Developing World I USD Acc"
master_key: "IE00BYQRBG58"
isin: "IE00BYQRBG58"
...
# 🌐 Artisan Developing World I USD Acc

**ISIN:** `IE00BYQRBG58` · **Ticker:** `0P0001FT6Z`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Artisan Developing World I USD Acc |
| ISIN | `IE00BYQRBG58` |
...
| ผู้จัดการกองทุน | Lewis S. Kaufman (เริ่ม 29 Jan 2019) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2019-01-28 |
...
|---|---|
| เทคโนโลยี | 39.62% |
| สินค้าฟุ่มเฟือย | 25.99% |
| การเงิน | 16.08% |
| สื่อสาร | 9.36% |
| สินค้าจำเป็น | 4.71% |
| สุขภาพ | 2.18% |
| อุตสาหกรรม | 1.15% |
| อสังหาริมทรัพย์ | 0.90% |
...
|---|---|---|---|---|---|
| [[DAOL-DEWORLD]] | [[บริษัทหลักทรัพย์จัดการกองทุน ดาโอ จำกัด]] | 6 | 97.49% | 2.47 | **≈ 3.53** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001FT6Z`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=IE00BYQRBG58:USD))
