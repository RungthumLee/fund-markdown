---
title: "Schroder ISF Global Innov A Acc USD"
master_key: "name:schroder international selection global innovation"
...
# 🌐 Schroder ISF Global Innov A Acc USD
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Schroder ISF Global Innov A Acc USD |
| ISIN | - |
...
| ผู้จัดการกองทุน | Alex Tedder (เริ่ม 12 Dec 2018) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2019-06-12 |
...
|---|---|---|---|---|---|
| [[LHMEGA]] | [[บริษัทหลักทรัพย์จัดการกองทุน แลนด์ แอนด์ เฮ้าส์ จำกัด]] | 6 | 99.77% | 2.10 | **≈ 3.94** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001FA8X`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU1910165726:USD))
- **ค้นเว็บ** — พบ ISIN `LU1910165726` แล้วยืนยันตัวเลขซ้ำกับ FT/Yahoo อีกชั้น
