---
title: "PIMCO GIS Total Return Bond Fund E Class USD Accumulation"
master_key: "IE00B11XZ988"
isin: "IE00B11XZ988"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | PIMCO GIS Total Return Bond Fund E Class USD Accumulation |
| ISIN | `IE00B11XZ988` |
| โครงสร้างทางกฎหมาย | Open Ended Investment Company |
| ประเทศจดทะเบียน | Ireland |
| หมวด (Morningstar) | USD Diversified Bond |
| ผู้จัดการกองทุน | Mohit Mittal (เริ่ม 10 Dec 2019) |
| วันจัดตั้ง | - |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (FT) | 3.08bn GBP |
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **1.40%** |
...
|---|---|---|---|---|
| [[KFTRB]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงศรี จำกัด]] | ตราสารหนี้ | 4 | 100.22% |

---

## แหล่งข้อมูล

- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=IE00B11XZ988:USD))
