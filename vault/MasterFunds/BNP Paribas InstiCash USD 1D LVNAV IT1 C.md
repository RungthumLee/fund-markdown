---
title: "BNP Paribas InstiCash USD 1D LVNAV IT1 C"
master_key: "LU2594160355"
isin: "LU2594160355"
...
**ISIN:** `LU2594160355` · **Ticker:** `0P0001RNCN`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | BNP Paribas InstiCash USD 1D LVNAV IT1 C |
| ISIN | `LU2594160355` |
...
| ผู้จัดการกองทุน | Olivier Heurtaut (เริ่ม 12 Dec 2016) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2008-07-16 |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (FT) | 11.65bn GBP |
| ขนาดกองทุน (Yahoo) | 15.68 พันล้าน USD |
...
|---|---|---|---|---|---|
| [[ASP-USDL]] | [[บริษัทหลักทรัพย์จัดการกองทุน แอสเซท พลัส จำกัด]] | 4 | 99.86% | 0.48 | - |
| [[SCBUSDYIELD]] | [[บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด]] | 4 | 98.27% | 0.55 | - |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001RNCN`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU2594160355:USD))
