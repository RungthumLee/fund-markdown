---
title: "JPM US Aggregate Bond C acc USD"
master_key: "LU0217389567"
isin: "LU0217389567"
...
**ISIN:** `LU0217389567` · **Ticker:** `0P00001EZL`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | JPM US Aggregate Bond C acc USD |
| ISIN | `LU0217389567` |
...
|---|---|---|---|---|
| [[TUSBOND]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทิสโก้]] | ตราสารหนี้ | 4 | 98.60% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P00001EZL`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0217389567:USD))
