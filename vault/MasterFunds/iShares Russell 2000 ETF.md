...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | iShares Russell 2000 ETF |
| ISIN | `US4642876555` |
...
| สกุลเงิน | USD |
| วันจัดตั้ง | 2000-05-22 |

## ขนาดกองทุนและค่าธรรมเนียม

| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 80.11 พันล้าน USD |
...
|---|---|
| YTD | 18.77% |
| 3 ปี (เฉลี่ยต่อปี) | 19.00% |
| 5 ปี (เฉลี่ยต่อปี) | 7.43% |
| Beta (3 ปี) | 1.26 |
...
| เทคโนโลยี | 13.78% |
| อุตสาหกรรม | 13.54% |
| สินค้าฟุ่มเฟือย | 9.24% |
| อสังหาริมทรัพย์ | 6.86% |
| พลังงาน | 6.01% |
| วัตถุดิบ | 4.19% |
| สาธารณูปโภค | 2.79% |
| สินค้าจำเป็น | 2.73% |
...
|---|---|---|---|---|---|
| [[SCBRS2000]] | [[บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด]] | 6 | 104.40% | 0.10 | **≈ 0.29** |
| [[B-US2000P]] | [[บริษัทหลักทรัพย์จัดการกองทุนรวม บัวหลวง จำกัด]] | 6 | 99.18% | 0.90 | **≈ 1.09** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `IWM`)
