---
title: "BNY Mellon Global Credit USD W Acc"
master_key: "IE00BYZW5L40"
isin: "IE00BYZW5L40"
...
**ISIN:** `IE00BYZW5L40` · **Ticker:** `0P00017KKG`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | BNY Mellon Global Credit USD W Acc |
| ISIN | `IE00BYZW5L40` |
...
| ผู้จัดการกองทุน | Adam Whiteley (เริ่ม 29 Feb 2016) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2023-06-21 |
...
|---|---|---|---|---|
| [[PRINCIPAL GCREDIT]] | [[บริษัทหลักทรัพย์จัดการกองทุน พรินซิเพิล จำกัด]] | ตราสารหนี้ | 5 | 101.61% |
| [[TGBOND]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทิสโก้]] | ตราสารหนี้ | 5 | 98.58% |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P00017KKG`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=IE00BYZW5L40:USD))
