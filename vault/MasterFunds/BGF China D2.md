...
**ISIN:** `LU0359204475` · **Ticker:** `0P0000GC7A`
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (FT) | 729.18m GBP |
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **1.07%** |
...
| สื่อสาร | 15.86% |
| การเงิน | 14.92% |
| สินค้าฟุ่มเฟือย | 14.38% |
| อุตสาหกรรม | 11.03% |
| วัตถุดิบ | 6.88% |
| สินค้าจำเป็น | 4.75% |
| พลังงาน | 3.47% |
| สุขภาพ | 2.60% |
| อสังหาริมทรัพย์ | 2.12% |
...
|---|---|---|---|---|---|
| [[KT-CHINA]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงไทย จำกัด (มหาชน)]] | 6 | 98.91% | 1.54 | **≈ 2.61** |
| [[KT-CHINA RMF]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงไทย จำกัด (มหาชน)]] | 6 | 97.98% | - | - |

> **รวม 2 ชั้น** = TER ของกองไทย + OCF ของกองหลัก (**1.07%**) — ค่าธรรมเนียมที่แท้จริงที่ผู้ลงทุนไทยแบกทั้งหมด · ดู [[../Concepts/ค่าธรรมเนียมสองชั้นของ Feeder Fund|ค่าธรรมเนียมสองชั้น]]
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0000GC7A`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0359204475:USD))
