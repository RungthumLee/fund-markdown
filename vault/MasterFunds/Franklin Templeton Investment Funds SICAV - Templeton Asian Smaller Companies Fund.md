---
title: "Franklin Templeton Investment Funds SICAV - Templeton Asian Smaller Companies Fund"
master_key: "name:templeton asian smaller companies"
quote_type: "ETF"
currency: "EUR"
feeder_count: 1
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Franklin Templeton Investment Funds SICAV - Templeton Asian Smaller Companies Fund |
| ISIN | - |
...
|---|---|---|---|---|---|
| [[K-ASIA]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | 6 | 101.17% | 1.74 | - |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `F7TC.F`)
