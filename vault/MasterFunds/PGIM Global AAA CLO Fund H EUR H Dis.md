---
title: "PGIM Global AAA CLO Fund H EUR H Dis"
master_key: "name:pgim global aaa clo"
...
# 🌐 PGIM Global AAA CLO Fund H EUR H Dis
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | PGIM Global AAA CLO Fund H EUR H Dis |
| ISIN | - |
| ประเภท | กองทุนรวม (ไม่ได้จดทะเบียนซื้อขาย) |
| ประเทศจดทะเบียน | ลักเซมเบิร์ก |
| สกุลเงิน | EUR |
| วันจัดตั้ง | 2026-05-15 |
...
|---|---|---|---|---|---|
| [[KKP AAA CLO-USD]] | [[บริษัทหลักทรัพย์จัดการกองทุน เกียรตินาคินภัทร จำกัด]] | 4 | 99.07% | - | - |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P00035FVB.F`)
