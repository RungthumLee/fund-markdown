---
title: "State Street Utilities Select Sector SPDR ETF"
master_key: "US81369Y8865"
isin: "US81369Y8865"
quote_type: "ETF"
category: "Utilities"
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 23.06 พันล้าน USD |
...
|---|---|---|---|
| 1 | NextEra Energy Inc | `NEE` | 13.03% |
| 2 | Southern Co | `SO` | 7.66% |
| 3 | Duke Energy Corp | `DUK` | 7.03% |
| 4 | Constellation Energy Corp | `CEG` | 6.04% |
| 5 | American Electric Power Co Inc | `AEP` | 5.00% |
| 6 | Dominion Energy Inc | `D` | 4.37% |
| 7 | Sempra | `SRE` | 4.16% |
| 8 | Entergy Corp | `ETR` | 3.54% |
| 9 | Xcel Energy Inc | `XEL` | 3.51% |
| 10 | Vistra Corp | `VST` | 3.38% |
...
|---|---|---|---|---|
| [[TUSUTIL]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทิสโก้]] | ตราสารทุน | 7 | 92.50% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `XLU`)
