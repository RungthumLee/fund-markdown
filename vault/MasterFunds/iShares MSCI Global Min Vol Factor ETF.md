---
title: "iShares MSCI Global Min Vol Factor ETF"
master_key: "US4642865251"
isin: "US4642865251"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | iShares MSCI Global Min Vol Factor ETF |
| ISIN | `US4642865251` |
...
| สกุลเงิน | USD |
| วันจัดตั้ง | 2011-10-18 |

## ขนาดกองทุนและค่าธรรมเนียม

| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 3.32 พันล้าน USD |
...
|---|---|
| YTD | 5.65% |
| 3 ปี (เฉลี่ยต่อปี) | 12.14% |
| 5 ปี (เฉลี่ยต่อปี) | 6.04% |
| Beta (3 ปี) | 0.43 |
...
| อุตสาหกรรม | 8.13% |
| สาธารณูปโภค | 7.16% |
| สินค้าฟุ่มเฟือย | 5.19% |
| พลังงาน | 3.66% |
| วัตถุดิบ | 1.47% |
| อสังหาริมทรัพย์ | 0.64% |
...
|---|---|---|---|
| 1 | Johnson & Johnson | `JNJ` | 1.56% |
| 2 | Cisco Systems Inc | `CSCO` | 1.46% |
| 3 | Motorola Solutions Inc | `MSI` | 1.22% |
| 4 | Taiwan Semiconductor Manufacturing Co Ltd | `2330.TW` | 1.21% |
| 5 | Microsoft Corp | `MSFT` | 1.21% |
| 6 | Duke Energy Corp | `DUK` | 1.20% |
| 7 | Cencora Inc | `COR` | 1.13% |
| 8 | Berkshire Hathaway Inc Class B | `BRK-B` | 1.08% |
| 9 | Southern Co | `SO` | 1.08% |
| 10 | KDDI Corp | `9433.T` | 1.05% |
...
|---|---|---|---|---|---|
| [[MGMVOL]] | [[บริษัทหลักทรัพย์จัดการกองทุน เอ็มเอฟซี จำกัด (มหาชน)]] | 6 | 101.11% | 0.91 | **≈ 1.11** |

> **รวม 2 ชั้น** = TER ของกองไทย + OCF ของกองหลัก (**0.20%**) — ค่าธรรมเนียมที่แท้จริงที่ผู้ลงทุนไทยแบกทั้งหมด · ดู [[../Concepts/ค่าธรรมเนียมสองชั้นของ Feeder Fund|ค่าธรรมเนียมสองชั้น]]

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `ACWV`)
