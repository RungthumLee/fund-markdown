---
title: "BNP Paribas Green Tigers I Cap"
master_key: "LU0823438493"
isin: "LU0823438493"
...
**ISIN:** `LU0823438493` · **Ticker:** `0P0001JN0M`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | BNP Paribas Green Tigers I Cap |
| ISIN | `LU0823438493` |
...
| ผู้จัดการกองทุน | Manish Bishnoi (เริ่ม 03 Oct 2023) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2014-08-26 |
...
| เทคโนโลยี | 50.86% |
| อุตสาหกรรม | 24.68% |
| สินค้าฟุ่มเฟือย | 9.77% |
| อสังหาริมทรัพย์ | 5.04% |
| สุขภาพ | 4.19% |
| การเงิน | 2.88% |
| สินค้าจำเป็น | 1.50% |
| สาธารณูปโภค | 1.07% |
...
|---|---|---|---|---|---|
| [[ONE-APACESG]] | [[บริษัทหลักทรัพย์จัดการกองทุน วรรณ จำกัด]] | 6 | 96.69% | 1.89 | **≈ 3.00** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001JN0M`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0823438493:USD))
