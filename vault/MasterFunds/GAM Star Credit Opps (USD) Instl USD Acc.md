...
**ISIN:** `IE00B5769310` · **Ticker:** `0P0000ZOR2`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | GAM Star Credit Opps (USD) Instl USD Acc |
| ISIN | `IE00B5769310` |
...
| ผู้จัดการกองทุน | Anthony Smouha (เริ่ม 19 Jul 2011) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2011-12-19 |
...
|---|---|---|---|---|
| [[SCBOPP]] | [[บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด]] | ผสม | 5 | 98.41% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0000ZOR2`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=IE00B5769310:USD))
