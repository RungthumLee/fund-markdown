---
title: "Invesco S&P MidCap Quality ETF"
master_key: "US46137V4721"
isin: "US46137V4721"
quote_type: "ETF"
...
| สกุลเงิน | USD |
| วันจัดตั้ง | 2006-12-01 |

## ขนาดกองทุนและค่าธรรมเนียม

| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 5.45 พันล้าน USD |
...
|---|---|
| YTD | 12.44% |
| 3 ปี (เฉลี่ยต่อปี) | 15.81% |
| 5 ปี (เฉลี่ยต่อปี) | 10.49% |
| Beta (3 ปี) | 0.9 |
...
|---|---|---|---|
| 1 | Illumina Inc | `ILMN` | 4.21% |
| 2 | TechnipFMC PLC | `FTI` | 4.14% |
| 3 | Everpure Inc Class A | `P` | 3.28% |
| 4 | Curtiss-Wright Corp | `CW` | 3.21% |
| 5 | Medpace Holdings Inc | `MEDP` | 3.13% |
| 6 | nVent Electric PLC | `NVT` | 2.93% |
| 7 | Manhattan Associates Inc | `MANH` | 2.79% |
| 8 | Exelixis Inc | `EXEL` | 2.70% |
| 9 | Carpenter Technology Corp | `CRS` | 2.69% |
| 10 | United Therapeutics Corp | `UTHR` | 2.53% |
...
|---|---|---|---|---|
| [[TUSMS]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทิสโก้]] | ตราสารทุน | 6 | 97.93% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `XMHQ`)
