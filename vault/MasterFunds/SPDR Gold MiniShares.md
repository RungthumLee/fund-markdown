...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | SPDR Gold MiniShares |
| ISIN | `US98149E3036` |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 27.37 พันล้าน USD |
...
|---|---|
| YTD | -6.58% |
| 3 ปี (เฉลี่ยต่อปี) | 34.48% |
| 5 ปี (เฉลี่ยต่อปี) | 21.00% |
| Beta (3 ปี) | 0.36 |
...
|---|---|---|---|---|
| [[ONE-GOLD]] | [[บริษัทหลักทรัพย์จัดการกองทุน วรรณ จำกัด]] | ทรัพย์สินทางเลือก | 8 | 96.84% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `GLDM`)
