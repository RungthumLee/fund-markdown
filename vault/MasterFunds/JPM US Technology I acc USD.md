...
**ISIN:** `LU0248060906` · **Ticker:** `0P00009PTP`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | JPM US Technology I acc USD |
| ISIN | `LU0248060906` |
...
| ผู้จัดการกองทุน | Joseph Wilson (เริ่ม 17 Feb 2017) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2025-12-12 |
...
|---|---|---|---|---|---|
| [[UUSTECH]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | 7 | 105.44% | 1.84 | **≈ 2.65** |
| [[UGDIVP-USD]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | 6 | 99.32% | 1.55 | **≈ 2.36** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P00009PTP`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0248060906:USD))
