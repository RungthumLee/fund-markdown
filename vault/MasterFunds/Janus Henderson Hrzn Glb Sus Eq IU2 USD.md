---
title: "Janus Henderson Hrzn Glb Sus Eq IU2 USD"
master_key: "LU1983259703"
isin: "LU1983259703"
...
# 🌐 Janus Henderson Hrzn Glb Sus Eq IU2 USD

**ISIN:** `LU1983259703` · **Ticker:** `0P0001HNBU`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Janus Henderson Hrzn Glb Sus Eq IU2 USD |
| ISIN | `LU1983259703` |
...
| ผู้จัดการกองทุน | Hamish Chamberlayne (เริ่ม 29 May 2019) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2019-07-08 |
...
| การเงิน | 19.49% |
| สุขภาพ | 11.71% |
| สินค้าฟุ่มเฟือย | 5.43% |
| สื่อสาร | 3.77% |
| อสังหาริมทรัพย์ | 2.65% |
...
|---|---|---|---|---|---|
| [[SCBGEESG]] | [[บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด]] | 6 | 98.68% | 1.72 | **≈ 2.55** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001HNBU`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU1983259703:USD))
