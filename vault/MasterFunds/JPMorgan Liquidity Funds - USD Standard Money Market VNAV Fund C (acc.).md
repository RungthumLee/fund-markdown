---
title: "JPMorgan Liquidity Funds - USD Standard Money Market VNAV Fund C (acc.)"
master_key: "name:jpmorgan liquidity standard money market vnav jpm c"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | JPMorgan Liquidity Funds - USD Standard Money Market VNAV Fund C (acc.) |
| ISIN | - |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | USD Money Market |
| ผู้จัดการกองทุน | Doris Grillo (เริ่ม 01 Nov 2022) |
| วันจัดตั้ง | - |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (FT) | 16.67bn GBP |
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **0.21%** |
...
|---|---|---|---|---|
| [[K-GSF(USD)]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | ตราสารหนี้ | 4 | 100.00% |
| [[K-GSF(UH)]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | ตราสารหนี้ | 4 | 93.34% |
...
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0088277610:USD))
- **ค้นเว็บ** — พบ ISIN `LU0088277610` แล้วยืนยันตัวเลขซ้ำกับ FT/Yahoo อีกชั้น
