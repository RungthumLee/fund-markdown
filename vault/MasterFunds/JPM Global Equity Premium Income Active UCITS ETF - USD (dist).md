---
title: "JPM Global Equity Premium Income Active UCITS ETF - USD (dist)"
master_key: "name:jpmorgan etfs ireland icav global equity premium income active ucits etf dist"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | JPM Global Equity Premium Income Active UCITS ETF - USD (dist) |
| ISIN | - |
...
| อุตสาหกรรม | 7.87% |
| สาธารณูปโภค | 7.24% |
| สินค้าฟุ่มเฟือย | 5.80% |
| วัตถุดิบ | 4.04% |
| อสังหาริมทรัพย์ | 2.32% |
| พลังงาน | 1.48% |
...
|---|---|---|---|---|---|
| [[K-GPIN]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | 6 | 101.02% | 0.92 | - |
| [[K-GPINUH]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | 6 | 97.34% | 0.96 | - |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `JEPG.L`)
- **ค้นเว็บ** — พบ ISIN `IE0003UVYC20` แล้วยืนยันตัวเลขซ้ำกับ FT/Yahoo อีกชั้น
