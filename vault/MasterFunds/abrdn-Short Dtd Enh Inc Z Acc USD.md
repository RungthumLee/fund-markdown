---
title: "abrdn-Short Dtd Enh Inc Z Acc USD"
master_key: "LU2628680014"
isin: "LU2628680014"
...
**ISIN:** `LU2628680014` · **Ticker:** `0P0001R9N0`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | abrdn-Short Dtd Enh Inc Z Acc USD |
| ISIN | `LU2628680014` |
| ประเภท | กองทุนรวม (ไม่ได้จดทะเบียนซื้อขาย) |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | USD Corporate Bond - Short Term |
| ผู้จัดการกองทุน | Mark Munro (เริ่ม 06 Jul 2023) |
| สกุลเงิน | USD |
...
|---|---|---|---|---|---|
| [[ABGFIX-M]] | [[บริษัทหลักทรัพย์จัดการกองทุน อเบอร์ดีน (ประเทศไทย) จำกัด]] | 4 | 89.31% | 0.70 | - |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001R9N0`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU2628680014:USD))
