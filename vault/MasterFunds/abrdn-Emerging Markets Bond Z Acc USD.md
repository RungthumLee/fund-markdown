---
title: "abrdn-Emerging Markets Bond Z Acc USD"
master_key: "LU0278912091"
isin: "LU0278912091"
...
# 🌐 abrdn-Emerging Markets Bond Z Acc USD

**ISIN:** `LU0278912091` · **Ticker:** `0P0000FWUQ`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | abrdn-Emerging Markets Bond Z Acc USD |
| ISIN | `LU0278912091` |
...
| ผู้จัดการกองทุน | Edwin Gutierrez (เริ่ม 02 Dec 2005) |
| สกุลเงิน | USD |
...
|---|---|---|---|---|
| [[AEOB]] | [[บริษัทหลักทรัพย์จัดการกองทุน อเบอร์ดีน (ประเทศไทย) จำกัด]] | ตราสารหนี้ | 6 | 99.34% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0000FWUQ`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0278912091:USD))
