---
title: "E.P.I.C Global Equity Opps Instl I (USD)"
master_key: "IE000XAUGXW1"
isin: "IE000XAUGXW1"
...
# 🌐 E.P.I.C Global Equity Opps Instl I (USD)

**ISIN:** `IE000XAUGXW1` · **Ticker:** `0P0001O923`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | E.P.I.C Global Equity Opps Instl I (USD) |
| ISIN | `IE000XAUGXW1` |
...
| อุตสาหกรรม | 12.04% |
| สุขภาพ | 8.86% |
| สินค้าฟุ่มเฟือย | 8.42% |
| สื่อสาร | 5.99% |
| อสังหาริมทรัพย์ | 3.68% |
| วัตถุดิบ | 2.58% |
| สาธารณูปโภค | 2.37% |
| สินค้าจำเป็น | 1.90% |
| พลังงาน | 0.30% |
...
|---|---|---|---|---|---|
| [[KT-EPIC]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงไทย จำกัด (มหาชน)]] | 6 | 99.59% | 1.36 | - |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001O923`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=IE000XAUGXW1:USD))
