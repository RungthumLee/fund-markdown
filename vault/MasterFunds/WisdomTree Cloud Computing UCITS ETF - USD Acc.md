---
title: "WisdomTree Cloud Computing UCITS ETF - USD Acc"
master_key: "IE00BJGWQN72"
isin: "IE00BJGWQN72"
...
**ISIN:** `IE00BJGWQN72` · **Ticker:** `IE00BJGWQN72.SG`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | WisdomTree Cloud Computing UCITS ETF - USD Acc |
| ISIN | `IE00BJGWQN72` |
...
|---|---|---|---|---|---|
| [[PRINCIPAL GCLOUD]] | [[บริษัทหลักทรัพย์จัดการกองทุน พรินซิเพิล จำกัด]] | 7 | 101.44% | 1.96 | - |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `IE00BJGWQN72.SG`)
