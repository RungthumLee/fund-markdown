---
title: "Capital Group New Economy Fund (LUX) BL"
master_key: "name:capital group new economy lux z"
...
# 🌐 Capital Group New Economy Fund (LUX) BL
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Capital Group New Economy Fund (LUX) BL |
| ISIN | - |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | Global Large-Cap Growth Equity |
| ผู้จัดการกองทุน | Paul R. Benjamin (เริ่ม 01 May 2023) |
| วันจัดตั้ง | - |
...
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **1.50%** |
...
|---|---|---|---|---|
| [[K-GNEXT]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | ตราสารทุน | 6 | 102.15% |

---

## แหล่งข้อมูล

- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU2211193391:USD))
- **ค้นเว็บ** — พบ ISIN `LU2211193391` แล้วยืนยันตัวเลขซ้ำกับ FT/Yahoo อีกชั้น
