---
title: "iShares MSCI World Islamic UCITS ETF USD (Dist)"
master_key: "IE00B27YCN58"
isin: "IE00B27YCN58"
quote_type: "ETF"
...
**ISIN:** `IE00B27YCN58` · **Ticker:** `ISDW.L`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | iShares MSCI World Islamic UCITS ETF USD (Dist) |
| ISIN | `IE00B27YCN58` |
...
| สกุลเงิน | USD |
| วันจัดตั้ง | 2007-12-07 |

## ขนาดกองทุนและค่าธรรมเนียม

| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 1.47 พันล้าน USD |
...
|---|---|
| YTD | 14.96% |
| 3 ปี (เฉลี่ยต่อปี) | 18.44% |
| 5 ปี (เฉลี่ยต่อปี) | 11.64% |
| Beta (3 ปี) | 0.86 |
...
| พลังงาน | 11.58% |
| วัตถุดิบ | 8.85% |
| สินค้าฟุ่มเฟือย | 5.70% |
| สินค้าจำเป็น | 3.41% |
| สาธารณูปโภค | 0.83% |
| สื่อสาร | 0.41% |
| อสังหาริมทรัพย์ | 0.25% |
...
|---|---|---|---|---|---|
| [[KT-WISLAMIC]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงไทย จำกัด (มหาชน)]] | 6 | 97.30% | 0.67 | **≈ 1.27** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `ISDW.L`)
