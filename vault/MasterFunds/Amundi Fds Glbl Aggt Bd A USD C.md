---
title: "Amundi Fds Glbl Aggt Bd A USD C"
master_key: "LU0319688015"
isin: "LU0319688015"
...
# 🌐 Amundi Fds Glbl Aggt Bd A USD C

**ISIN:** `LU0319688015` · **Ticker:** `LU0319688015-USD.LU`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Amundi Fds Glbl Aggt Bd A USD C |
| ISIN | `LU0319688015` |
...
| ผู้จัดการกองทุน | Gr�goire Pesques (เริ่ม 01 Sep 2022) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2010-05-17 |
...
|---|---|---|---|---|
| [[I-SMART]] | [[บริษัทหลักทรัพย์จัดการกองทุน เอ็มเอฟซี จำกัด (มหาชน)]] | ผสม | 5 | 106.20% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `LU0319688015-USD.LU`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0319688015:USD))
