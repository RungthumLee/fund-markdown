---
title: "VanEck Morningstar Wide Moat ETF"
master_key: "US92189F6438"
isin: "US92189F6438"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | VanEck Morningstar Wide Moat ETF |
| ISIN | `US92189F6438` |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 11.80 พันล้าน USD |
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **0.46%** |
| Yield | 1.30% |
...
|---|---|
| YTD | 4.36% |
| 3 ปี (เฉลี่ยต่อปี) | 14.85% |
| 5 ปี (เฉลี่ยต่อปี) | 9.66% |
| Beta (3 ปี) | 0.9 |
...
| สุขภาพ | 18.56% |
| สินค้าจำเป็น | 17.67% |
| สินค้าฟุ่มเฟือย | 11.32% |
| การเงิน | 10.35% |
| อุตสาหกรรม | 9.17% |
| สื่อสาร | 2.23% |
| อสังหาริมทรัพย์ | 0.71% |
...
|---|---|---|---|
| 1 | Charles Schwab Corp | `SCHW` | 2.67% |
| 2 | LPL Financial Holdings Inc | `LPLA` | 2.67% |
| 3 | Veeva Systems Inc Class A | `VEEV` | 2.64% |
| 4 | Bristol-Myers Squibb Co | `BMY` | 2.64% |
| 5 | Airbnb Inc Ordinary Shares - Class A | `ABNB` | 2.62% |
| 6 | Brown-Forman Corp Registered Shs -B- Non Vtg | `BF-B` | 2.60% |
| 7 | Microsoft Corp | `MSFT` | 2.57% |
| 8 | Masco Corp | `MAS` | 2.53% |
| 9 | Kenvue Inc | `KVUE` | 2.53% |
| 10 | Mondelez International Inc Class A | `MDLZ` | 2.46% |
...
|---|---|---|---|---|
| [[AFMOAT-H]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทาลิส จำกัด]] | ตราสารทุน | 6 | 100.45% |
| [[AFMOATHRMF]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทาลิส จำกัด]] | ตราสารทุน | 6 | 100.16% |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `MOAT`)
