---
title: "abrdn-Nrth American Sml Comp Z Acc USD"
master_key: "LU1725895533"
isin: "LU1725895533"
...
# 🌐 abrdn-Nrth American Sml Comp Z Acc USD

**ISIN:** `LU1725895533` · **Ticker:** `0P0001CGIU`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | abrdn-Nrth American Sml Comp Z Acc USD |
| ISIN | `LU1725895533` |
...
| ผู้จัดการกองทุน | Chris Colarik (เริ่ม 31 Mar 2023) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2026-07-21 |
...
| การเงิน | 19.60% |
| สุขภาพ | 14.73% |
| สินค้าฟุ่มเฟือย | 14.42% |
| เทคโนโลยี | 13.51% |
| วัตถุดิบ | 6.01% |
| สินค้าจำเป็น | 4.58% |
| อสังหาริมทรัพย์ | 2.45% |
| พลังงาน | 2.36% |
| สาธารณูปโภค | 0.42% |
...
|---|---|---|---|---|---|
| [[ABAGS-M]] | [[บริษัทหลักทรัพย์จัดการกองทุน อเบอร์ดีน (ประเทศไทย) จำกัด]] | 6 | 101.13% | 2.03 | **≈ 2.15** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001CGIU`)
