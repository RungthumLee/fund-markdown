---
title: "Invesco International BuyBack Achievers ETF"
master_key: "US46138E6445"
isin: "US46138E6445"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Invesco International BuyBack Achievers ETF |
| ISIN | `US46138E6445` |
...
| สกุลเงิน | USD |
| วันจัดตั้ง | 2014-02-27 |

## ขนาดกองทุนและค่าธรรมเนียม

| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 572.76 ล้าน USD |
...
|---|---|
| YTD | 11.62% |
| 3 ปี (เฉลี่ยต่อปี) | 25.17% |
| 5 ปี (เฉลี่ยต่อปี) | 11.71% |
| Beta (3 ปี) | 0.68 |
...
|---|---|---|---|
| 1 | ING Groep NV | `INGA.AS` | 6.25% |
| 2 | UniCredit SpA | `UCG.MI` | 6.09% |
| 3 | Standard Chartered PLC | `STAN.L` | 5.21% |
| 4 | Prosus NV Ordinary Shares - Class N | `PRX.AS` | 4.69% |
| 5 | Honda Motor Co Ltd | `7267.T` | 4.40% |
| 6 | Shell PLC | `SHEL.L` | 4.39% |
| 7 | TotalEnergies SE | `TTE.PA` | 4.28% |
| 8 | Equinor ASA | `EQNR.OL` | 3.34% |
| 9 | Sompo Holdings Inc | `8630.T` | 2.66% |
| 10 | Vodafone Group PLC | `VOD.L` | 2.41% |
...
|---|---|---|---|---|---|
| [[U-WXUSFX]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | 6 | 99.41% | 1.55 | **≈ 2.10** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `IPKW`)
