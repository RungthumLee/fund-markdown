...
master_key: "name:first trust natural gas etf"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 650.78 ล้าน MXN |
...
|---|---|---|---|---|---|
| [[LHGAS]] | [[บริษัทหลักทรัพย์จัดการกองทุน แลนด์ แอนด์ เฮ้าส์ จำกัด]] | - | 94.11% | 2.10 | **≈ 2.69** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `FCG.MX`)
