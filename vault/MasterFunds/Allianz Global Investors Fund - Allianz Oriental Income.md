---
title: "Allianz Global Investors Fund - Allianz Oriental Income"
master_key: "LU0348784397"
isin: "LU0348784397"
quote_type: "ETF"
...
**ISIN:** `LU0348784397` · **Ticker:** `UQ25.F`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Allianz Global Investors Fund - Allianz Oriental Income |
| ISIN | `LU0348784397` |
| ประเภท | ETF (จดทะเบียนซื้อขายในตลาด) |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | Asia-Pacific Equity |
| ผู้จัดการกองทุน | Stuart Winchester (เริ่ม 01 Jan 2000) |
| สกุลเงิน | EUR |
| วันจัดตั้ง | - |
...
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **1.86%** |
...
|---|---|---|---|---|
| [[KF-ORTFLEX]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงศรี จำกัด]] | ผสม | 6 | 99.59% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `UQ25.F`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0348784397:USD))
