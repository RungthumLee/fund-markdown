---
title: "Vanguard Real Estate Index Fund ETF Shares"
master_key: "US9229085538"
isin: "US9229085538"
quote_type: "ETF"
...
|---|---|---|---|
| 1 | Vanguard Real Estate II Index | `VRTPX` | 14.41% |
| 2 | Welltower Inc | `WELL` | 8.46% |
| 3 | Prologis Inc | `PLD` | 6.97% |
| 4 | Equinix Inc | `EQIX` | 5.20% |
| 5 | American Tower Corp | `AMT` | 4.18% |
| 6 | Simon Property Group Inc | `SPG` | 3.85% |
| 7 | Digital Realty Trust Inc | `DLR` | 3.35% |
| 8 | Realty Income Corp | `O` | 3.06% |
| 9 | Public Storage | `PSA` | 2.81% |
| 10 | Ventas Inc | `VTR` | 2.30% |
...
|---|---|---|---|---|
| [[TUSREIT]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทิสโก้]] | ทรัพย์สินทางเลือก | 8 | 99.23% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `VNQ`)
