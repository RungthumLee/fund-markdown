---
title: "iShares U.S. Financial Services ETF"
master_key: "name:ishares u s financial services etf"
quote_type: "ETF"
category: "Financial"
fund_family: "iShares"
currency: "USD"
...
| สกุลเงิน | USD |
| วันจัดตั้ง | 2000-06-12 |

## ขนาดกองทุนและค่าธรรมเนียม

| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 2.17 พันล้าน USD |
...
|---|---|
| YTD | 4.11% |
| 3 ปี (เฉลี่ยต่อปี) | 24.44% |
| 5 ปี (เฉลี่ยต่อปี) | 10.47% |
| Beta (3 ปี) | 0.86 |
...
|---|---|---|---|
| 1 | JPMorgan Chase & Co | `JPM` | 13.03% |
| 2 | Berkshire Hathaway Inc Class B | `BRK-B` | 12.97% |
| 3 | Visa Inc Class A | `V` | 8.40% |
| 4 | Mastercard Inc Class A | `MA` | 6.39% |
| 5 | Bank of America Corp | `BAC` | 5.59% |
| 6 | The Goldman Sachs Group Inc | `GS` | 4.15% |
| 7 | Wells Fargo & Co | `WFC` | 3.66% |
| 8 | Morgan Stanley | `MS` | 3.49% |
| 9 | Citigroup Inc | `C` | 3.11% |
...
|---|---|---|---|---|---|
| [[LHUSFIN]] | [[บริษัทหลักทรัพย์จัดการกองทุน แลนด์ แอนด์ เฮ้าส์ จำกัด]] | 7 | 95.41% | 1.95 | **≈ 2.33** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `IYG`)
