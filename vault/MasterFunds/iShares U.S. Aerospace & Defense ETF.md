...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | iShares U.S. Aerospace & Defense ETF |
| ISIN | `US4642887602` |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 14.10 พันล้าน USD |
...
|---|---|
| YTD | 11.76% |
| 3 ปี (เฉลี่ยต่อปี) | 28.06% |
| 5 ปี (เฉลี่ยต่อปี) | 18.05% |
| Beta (3 ปี) | 1.0 |
...
|---|---|---|---|
| 1 | GE Aerospace | `GE` | 22.06% |
| 2 | RTX Corp | `RTX` | 17.02% |
| 3 | Boeing Co | `BA` | 9.00% |
| 4 | Howmet Aerospace Inc | `HWM` | 4.78% |
| 5 | General Dynamics Corp | `GD` | 4.75% |
| 6 | Lockheed Martin Corp | `LMT` | 4.69% |
| 7 | TransDigm Group Inc | `TDG` | 4.37% |
| 8 | Northrop Grumman Corp | `NOC` | 4.23% |
| 9 | L3Harris Technologies Inc | `LHX` | 3.67% |
| 10 | Axon Enterprise Inc | `AXON` | 3.02% |
...
|---|---|---|---|---|
| [[TDEFENSE]] | [[บริษัทหลักทรัพย์จัดการกองทุน ทิสโก้]] | ตราสารทุน | 7 | 96.96% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `ITA`)
