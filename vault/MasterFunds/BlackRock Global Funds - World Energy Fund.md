---
title: "BlackRock Global Funds - World Energy Fund"
master_key: "LU0122376428"
isin: "LU0122376428"
quote_type: "ETF"
...
**ISIN:** `LU0122376428` · **Ticker:** `ERDN.F`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | BlackRock Global Funds - World Energy Fund |
| ISIN | `LU0122376428` |
| ประเภท | ETF (จดทะเบียนซื้อขายในตลาด) |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | Sector Equity Energy |
| สกุลเงิน | EUR |
| วันจัดตั้ง | - |
...
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **2.06%** |
...
|---|---|---|---|---|
| [[KT-ENERGY]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงไทย จำกัด (มหาชน)]] | ตราสารทุน | 7 | 96.63% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `ERDN.F`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0122376428:USD))
