---
title: "iShares S&P 500 Information Technology Sector UCITS ETF USD (Acc)"
master_key: "IE00B3WJKG14"
isin: "IE00B3WJKG14"
quote_type: "ETF"
...
**ISIN:** `IE00B3WJKG14` · **Ticker:** `IUIT.L`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | iShares S&P 500 Information Technology Sector UCITS ETF USD (Acc) |
| ISIN | `IE00B3WJKG14` |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 18.38 พันล้าน USD |
...
|---|---|
| YTD | 15.75% |
| 3 ปี (เฉลี่ยต่อปี) | 32.24% |
| 5 ปี (เฉลี่ยต่อปี) | 20.32% |
| Beta (3 ปี) | 0.96 |
...
|---|---|---|---|---|---|
| [[ES-USTECH]] | [[บริษัทหลักทรัพย์จัดการกองทุน อีสท์สปริง (ประเทศไทย) จำกัด]] | 7 | 100.40% | 1.25 | **≈ 1.40** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `IUIT.L`)
