---
title: "JPMorgan Investment Funds - Global Balanced Fund C (acc) - USD (hedged)"
master_key: "LU0957039927"
isin: "LU0957039927"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | JPMorgan Investment Funds - Global Balanced Fund C (acc) - USD (hedged) |
| ISIN | `LU0957039927` |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | USD Moderate Allocation |
| ผู้จัดการกองทุน | Katy Thorneycroft (เริ่ม 13 Feb 2018) |
| วันจัดตั้ง | - |
...
|---|---|---|---|---|
| [[UGBF]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | ผสม | 5 | 101.23% |
| [[UGBFRMF]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | ผสม | 5 | 101.08% |
...
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0957039927:USD))
