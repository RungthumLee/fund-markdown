---
title: "JPMorgan Funds - Global Healthcare Fund"
master_key: "name:pmorgan global healthcare a"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | JPMorgan Funds - Global Healthcare Fund |
| ISIN | - |
...
|---|---|---|---|---|
| [[K-GHEALTH(UH)]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | ตราสารทุน | 7 | 96.09% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `JYJV.F`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0432979614:USD))
