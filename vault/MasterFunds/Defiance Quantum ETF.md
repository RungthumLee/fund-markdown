---
title: "Defiance Quantum ETF"
master_key: "name:defiance quantum etf"
quote_type: "ETF"
category: "Technology"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Defiance Quantum ETF |
| ISIN | - |
...
|---|---|
| YTD | 29.65% |
| 3 ปี (เฉลี่ยต่อปี) | 46.21% |
| 5 ปี (เฉลี่ยต่อปี) | 25.32% |
| Beta (3 ปี) | 1.72 |
...
|---|---|---|---|
| 1 | Arqit Quantum Inc | `ARQQ` | 1.62% |
| 2 | Cloudflare Inc | `NET` | 1.57% |
| 3 | Snowflake Inc Ordinary Shares | `SNOW` | 1.51% |
| 4 | RTX Corp | `RTX` | 1.50% |
| 5 | Horizon Quantum Holdings Ltd Class A | `HQ` | 1.49% |
| 6 | NEC Corp | `6701.T` | 1.48% |
| 7 | Nutanix Inc Class A | `NTNX` | 1.47% |
| 8 | Microsoft Corp | `MSFT` | 1.45% |
| 9 | Airbus SE | `AIR.PA` | 1.43% |
| 10 | Amazon.com Inc | `AMZN` | 1.41% |
...
|---|---|---|---|---|---|
| [[LHQTUM]] | [[บริษัทหลักทรัพย์จัดการกองทุน แลนด์ แอนด์ เฮ้าส์ จำกัด]] | 7 | 102.17% | 1.47 | **≈ 1.87** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `QTUM`)
