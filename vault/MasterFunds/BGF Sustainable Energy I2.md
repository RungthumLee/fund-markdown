---
title: "BGF Sustainable Energy I2"
master_key: "LU0534476519"
isin: "LU0534476519"
...
**ISIN:** `LU0534476519` · **Ticker:** `0P0000PSJ6`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | BGF Sustainable Energy I2 |
| ISIN | `LU0534476519` |
...
| ผู้จัดการกองทุน | Alastair Bishop (เริ่ม 02 Nov 2015) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2001-04-06 |
...
|---|---|---|---|
| 1 | NextEra Energy Inc | `NEE` | 5.08% |
| 2 | National Grid PLC | `NG.L` | 5.03% |
| 3 | Linde PLC | `LIN` | 4.90% |
| 4 | Contemporary Amperex Technology Co Ltd Class A | `300750.SZ` | 4.71% |
| 5 | EDP Renovaveis SA | `EDPR.LS` | 4.13% |
| 6 | First Solar Inc | `FSLR` | 3.82% |
| 7 | Kingspan Group PLC | `KRX.IR` | 3.59% |
| 8 | Nextpower Inc Class A | `NXT` | 3.56% |
| 9 | Nexans | `NEX.PA` | 3.39% |
...
|---|---|---|---|---|
| [[MRENEW]] | [[บริษัทหลักทรัพย์จัดการกองทุน เอ็มเอฟซี จำกัด (มหาชน)]] | ตราสารทุน | 7 | 102.32% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0000PSJ6`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0534476519:USD))
