---
title: "AB EM Multi-Asset S1 USD"
master_key: "LU0633141881"
isin: "LU0633141881"
...
# 🌐 AB EM Multi-Asset S1 USD

**ISIN:** `LU0633141881` · **Ticker:** `0P0000TKF6`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | AB EM Multi-Asset S1 USD |
| ISIN | `LU0633141881` |
| ประเภท | กองทุนรวม (ไม่ได้จดทะเบียนซื้อขาย) |
| โครงสร้างทางกฎหมาย | SICAV |
| ประเทศจดทะเบียน | Luxembourg |
| หมวด (Morningstar) | Global Emerging Markets Allocation |
| ผู้จัดการกองทุน | Christian DiClementi (เริ่ม 01 Oct 2021) |
| สกุลเงิน | USD |
| วันจัดตั้ง | 2013-03-21 |
...
|---|---|---|---|---|---|
| [[UEMIF]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | 5 | 103.42% | 1.28 | **≈ 2.23** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0000TKF6`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0633141881:USD))
