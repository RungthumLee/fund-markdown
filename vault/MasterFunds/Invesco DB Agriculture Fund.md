...
master_key: "name:invesco db agriculture"
quote_type: "ETF"
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Invesco DB Agriculture Fund |
| ISIN | - |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 1.21 พันล้าน USD |
...
|---|---|
| YTD | 7.75% |
| 3 ปี (เฉลี่ยต่อปี) | 13.83% |
| 5 ปี (เฉลี่ยต่อปี) | 10.74% |
| Beta (3 ปี) | 0.32 |
...
|---|---|---|---|---|
| 1 | [[../Entities/Invesco Shrt-Trm Inv Gov&Agcy Instl\|Invesco Shrt-Trm Inv Gov&Agcy Instl]] | `AGPXX` | สหรัฐฯ | 41.35% |
| 2 | [[../Entities/Invesco Short Term Treasury ETF\|Invesco Short Term Treasury ETF]] | `TBLL` | สหรัฐฯ | 4.99% |
...
|---|---|---|---|---|---|
| [[K-AGRI]] | [[บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด]] | 8 | 100.70% | 0.73 | **≈ 1.58** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `DBA`)
