---
title: "JPMorgan Investment Funds – Global Macro Opportunities Fund"
master_key: "LU0095938881"
isin: "LU0095938881"
...
**ISIN:** `LU0095938881` · **Ticker:** `LU0095938881.SG`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | JPMorgan Investment Funds – Global Macro Opportunities Fund |
| ISIN | `LU0095938881` |
...
|---|---|---|---|---|
| [[UGMAC]] | [[บริษัทหลักทรัพย์จัดการกองทุน ยูโอบี (ประเทศไทย) จำกัด]] | ผสม | 5 | 99.83% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `LU0095938881.SG`)
