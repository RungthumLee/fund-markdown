---
title: "Fullerton Lux Global Abs Alpha I USD C"
master_key: "name:fullerton lux global absolute alpha"
...
# 🌐 Fullerton Lux Global Abs Alpha I USD C
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Fullerton Lux Global Abs Alpha I USD C |
| ISIN | - |
...
| ผู้จัดการกองทุน | Roslin Zhu (เริ่ม 18 Jun 2019) |
| สกุลเงิน | USD |
...
|---|---|---|---|---|---|
| [[LHGALPHA]] | [[บริษัทหลักทรัพย์จัดการกองทุน แลนด์ แอนด์ เฮ้าส์ จำกัด]] | 6 | 105.61% | 2.10 | **≈ 3.20** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `0P0001IWCJ`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU1988902786:USD))
- **ค้นเว็บ** — พบ ISIN `LU1988902786` แล้วยืนยันตัวเลขซ้ำกับ FT/Yahoo อีกชั้น
