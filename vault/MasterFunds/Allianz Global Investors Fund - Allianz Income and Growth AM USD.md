---
title: "Allianz Global Investors Fund - Allianz Income and Growth AM USD"
master_key: "LU0820561818"
isin: "LU0820561818"
...
**ISIN:** `LU0820561818` · **Ticker:** `LU0820561818.SG`
...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | Allianz Global Investors Fund - Allianz Income and Growth AM USD |
| ISIN | `LU0820561818` |
...
| ผู้จัดการกองทุน | Michael E. Yee (เริ่ม 01 Mar 2022) |
| สกุลเงิน | EUR |
| วันจัดตั้ง | - |
| นโยบายปันผล | Income |
...
| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (FT) | 42.37bn GBP |
| **ค่าธรรมเนียมรวมต่อปี (OCF/TER)** | **1.56%** |
...
|---|---|---|---|---|
| [[KT-IGF]] | [[บริษัทหลักทรัพย์จัดการกองทุน กรุงไทย จำกัด (มหาชน)]] | ผสม | 5 | 92.23% |

---

## แหล่งข้อมูล

- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `LU0820561818.SG`)
- **FT.com** — ค่าธรรมเนียม ขนาดกองทุน domicile ผู้จัดการ ([tearsheet](https://markets.ft.com/data/funds/tearsheet/summary?s=LU0820561818:USD))
