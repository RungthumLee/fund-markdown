...
| รายการ | ค่า |
|---|---|
| ชื่อกองทุน | iShares U.S. Medical Devices ETF |
| ISIN | `US4642888105` |
...
| สกุลเงิน | USD |
| วันจัดตั้ง | 2006-05-01 |

## ขนาดกองทุนและค่าธรรมเนียม

| รายการ | ค่า |
|---|---|
| ขนาดกองทุน (Yahoo) | 3.25 พันล้าน USD |
...
|---|---|
| YTD | -15.36% |
| 3 ปี (เฉลี่ยต่อปี) | 3.00% |
| 5 ปี (เฉลี่ยต่อปี) | -2.55% |
| Beta (3 ปี) | 0.81 |
...
|---|---|---|---|
| 1 | Abbott Laboratories | `ABT` | 18.59% |
| 2 | Intuitive Surgical Inc | `ISRG` | 12.64% |
| 3 | Stryker Corp | `SYK` | 11.35% |
| 4 | Becton Dickinson & Co | `BDX` | 4.77% |
| 5 | DexCom Inc | `DXCM` | 4.70% |
| 6 | Medtronic PLC | `MDT` | 4.53% |
| 7 | GE HealthCare Technologies Inc Common Stock | `GEHC` | 4.52% |
| 8 | ResMed Inc | `RMD` | 4.47% |
| 9 | IDEXX Laboratories Inc | `IDXX` | 4.28% |
| 10 | Edwards Lifesciences Corp | `EW` | 4.26% |
...
|---|---|---|---|---|---|
| [[ONE-MEDTECH]] | [[บริษัทหลักทรัพย์จัดการกองทุน วรรณ จำกัด]] | 7 | 98.52% | 1.90 | **≈ 2.27** |
...
- **Yahoo Finance** — โปรไฟล์ ผลตอบแทน sector holdings (symbol `IHI`)
